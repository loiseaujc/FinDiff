...
module stdlib_sparse_spmv
    ...
    interface spmv
        ...
        module procedure :: spmv_coo_1d_qp
        module procedure :: spmv_csr_1d_qp
        module procedure :: spmv_csc_1d_qp
        module procedure :: spmv_ell_1d_qp
        module procedure :: spmv_coo_2d_qp
        module procedure :: spmv_csr_2d_qp
        module procedure :: spmv_csc_2d_qp
        module procedure :: spmv_ell_2d_qp
        module procedure :: spmv_sellc_qp
        ...
        module procedure :: spmv_coo_1d_cqp
        module procedure :: spmv_csr_1d_cqp
        module procedure :: spmv_csc_1d_cqp
        module procedure :: spmv_ell_1d_cqp
        module procedure :: spmv_coo_2d_cqp
        module procedure :: spmv_csr_2d_cqp
        module procedure :: spmv_csc_2d_cqp
        module procedure :: spmv_ell_2d_cqp
        module procedure :: spmv_sellc_cqp
    end interface
    public :: spmv
...
contains
    ...
    subroutine spmv_coo_1d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:)
        real(qp), intent(inout) :: vec_y(:)
        real(qp), intent(in), optional :: alpha
        real(qp), intent(in), optional :: beta
        character(1), intent(in), optional :: op
        real(qp) :: alpha_
        character(1) :: op_
        integer(ilp) :: k, ik, jk
    ...
    subroutine spmv_coo_2d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:,:)
        real(qp), intent(inout) :: vec_y(:,:)
        real(qp), intent(in), optional :: alpha
    ...
    subroutine spmv_coo_1d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:)
        complex(qp), intent(inout) :: vec_y(:)
        complex(qp), intent(in), optional :: alpha
        complex(qp), intent(in), optional :: beta
        character(1), intent(in), optional :: op
        complex(qp) :: alpha_
        character(1) :: op_
        integer(ilp) :: k, ik, jk
    ...
    subroutine spmv_coo_2d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:,:)
        complex(qp), intent(inout) :: vec_y(:,:)
        complex(qp), intent(in), optional :: alpha
    ...
    subroutine spmv_csr_1d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:)
        real(qp), intent(inout) :: vec_y(:)
        real(qp), intent(in), optional :: alpha
        real(qp), intent(in), optional :: beta
    ...
    subroutine spmv_csr_2d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:,:)
        real(qp), intent(inout) :: vec_y(:,:)
        real(qp), intent(in), optional :: alpha
        ...
        character(1) :: op_
        integer(ilp) :: i, j
        real(qp) :: aux(size(vec_x,dim=1)), aux2(size(vec_x,dim=1))
    ...
    subroutine spmv_csr_1d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:)
        complex(qp), intent(inout) :: vec_y(:)
        complex(qp), intent(in), optional :: alpha
        complex(qp), intent(in), optional :: beta
    ...
    subroutine spmv_csr_2d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:,:)
        complex(qp), intent(inout) :: vec_y(:,:)
        complex(qp), intent(in), optional :: alpha
        ...
        character(1) :: op_
        integer(ilp) :: i, j
        complex(qp) :: aux(size(vec_x,dim=1)), aux2(size(vec_x,dim=1))
    ...
    subroutine spmv_csc_1d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:)
        real(qp), intent(inout) :: vec_y(:)
        real(qp), intent(in), optional :: alpha
        real(qp), intent(in), optional :: beta
    ...
    subroutine spmv_csc_2d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:,:)
        real(qp), intent(inout) :: vec_y(:,:)
        real(qp), intent(in), optional :: alpha
    ...
    subroutine spmv_csc_1d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:)
        complex(qp), intent(inout) :: vec_y(:)
        complex(qp), intent(in), optional :: alpha
        complex(qp), intent(in), optional :: beta
    ...
    subroutine spmv_csc_2d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:,:)
        complex(qp), intent(inout) :: vec_y(:,:)
        complex(qp), intent(in), optional :: alpha
    ...
    subroutine spmv_ell_1d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:)
        real(qp), intent(inout) :: vec_y(:)
        real(qp), intent(in), optional :: alpha
        real(qp), intent(in), optional :: beta
    ...
    subroutine spmv_ell_2d_qp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:,:)
        real(qp), intent(inout) :: vec_y(:,:)
        real(qp), intent(in), optional :: alpha
    ...
    subroutine spmv_ell_1d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:)
        complex(qp), intent(inout) :: vec_y(:)
        complex(qp), intent(in), optional :: alpha
        complex(qp), intent(in), optional :: beta
    ...
    subroutine spmv_ell_2d_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:,:)
        complex(qp), intent(inout) :: vec_y(:,:)
        complex(qp), intent(in), optional :: alpha
    ...
    subroutine spmv_sellc_qp(matrix,vec_x,vec_y,alpha,beta,op)
        !! This algorithm was gracefully provided by Ivan Privec and adapted by Jose Alves
        type(SELLC_qp_type), intent(in) :: matrix
        real(qp), intent(in)    :: vec_x(:)
        real(qp), intent(inout) :: vec_y(:)
        real(qp), intent(in), optional :: alpha
        real(qp), intent(in), optional :: beta
    ...
    contains
        pure subroutine chunk_kernel_4(n,a,col,x,y)
            integer, value      :: n
            real(qp), intent(in)  :: a(4,n), x(:)
            integer(ilp), intent(in) :: col(4,n)
            real(qp), intent(inout) :: y(4)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_8(n,a,col,x,y)
            integer, value      :: n
            real(qp), intent(in)  :: a(8,n), x(:)
            integer(ilp), intent(in) :: col(8,n)
            real(qp), intent(inout) :: y(8)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_16(n,a,col,x,y)
            integer, value      :: n
            real(qp), intent(in)  :: a(16,n), x(:)
            integer(ilp), intent(in) :: col(16,n)
            real(qp), intent(inout) :: y(16)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_rm(n,cs,r,a,col,x,y)
            integer, value      :: n, cs, r
            real(qp), intent(in)  :: a(cs,n), x(:)
            integer(ilp), intent(in) :: col(cs,n)
            real(qp), intent(inout) :: y(r)
            integer :: j
            do j = 1, n
                y(1:r) = y(1:r) + alpha_ * a(1:r,j) * x(col(1:r,j))
            end do
    ...
    subroutine spmv_sellc_cqp(matrix,vec_x,vec_y,alpha,beta,op)
        !! This algorithm was gracefully provided by Ivan Privec and adapted by Jose Alves
        type(SELLC_cqp_type), intent(in) :: matrix
        complex(qp), intent(in)    :: vec_x(:)
        complex(qp), intent(inout) :: vec_y(:)
        complex(qp), intent(in), optional :: alpha
        complex(qp), intent(in), optional :: beta
    ...
    contains
        pure subroutine chunk_kernel_4(n,a,col,x,y)
            integer, value      :: n
            complex(qp), intent(in)  :: a(4,n), x(:)
            integer(ilp), intent(in) :: col(4,n)
            complex(qp), intent(inout) :: y(4)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_4(n,a,col,x,y)
            integer, value      :: n
            complex(qp), intent(in)  :: a(4,n), x(4)
            integer(ilp), intent(in) :: col(4,n)
        ...
        pure subroutine chunk_kernel_8(n,a,col,x,y)
            integer, value      :: n
            complex(qp), intent(in)  :: a(8,n), x(:)
            integer(ilp), intent(in) :: col(8,n)
            complex(qp), intent(inout) :: y(8)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_8(n,a,col,x,y)
            integer, value      :: n
            complex(qp), intent(in)  :: a(8,n), x(8)
            integer(ilp), intent(in) :: col(8,n)
            complex(qp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
        ...
        pure subroutine chunk_kernel_16(n,a,col,x,y)
            integer, value      :: n
            complex(qp), intent(in)  :: a(16,n), x(:)
            integer(ilp), intent(in) :: col(16,n)
            complex(qp), intent(inout) :: y(16)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_16(n,a,col,x,y)
            integer, value      :: n
            complex(qp), intent(in)  :: a(16,n), x(16)
            integer(ilp), intent(in) :: col(16,n)
            complex(qp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
        ...
        pure subroutine chunk_kernel_rm(n,cs,r,a,col,x,y)
            integer, value      :: n, cs, r
            complex(qp), intent(in)  :: a(cs,n), x(:)
            integer(ilp), intent(in) :: col(cs,n)
            complex(qp), intent(inout) :: y(r)
            integer :: j
            do j = 1, n
                y(1:r) = y(1:r) + alpha_ * a(1:r,j) * x(col(1:r,j))
            end do
        ...
        pure subroutine chunk_kernel_rm_trans(n,cs,r,a,col,x,y)
            integer, value      :: n, cs, r
            complex(qp), intent(in)  :: a(cs,n), x(r)
            integer(ilp), intent(in) :: col(cs,n)
            complex(qp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
