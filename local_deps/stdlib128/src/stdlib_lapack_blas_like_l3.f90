  ...
  contains
     ...
     !! matrix in the second case.
        ...
        ! =====================================================================
           ...
           ! quick return if possible.
           ! the quick return case: ((alpha==0).and.(beta/=zero)) is not
           ! done (it is in stdlib_wherk for example) and left in the general case.
           if( ( n==0_ilp ) .or. ( ( ( alpha==zero ) .or. ( k==0_ilp ) ) .and.( beta==one ) ) )&
                     return
           if( ( alpha==zero ) .and. ( beta==zero ) ) then
              do j = 1, ( ( n*( n+1 ) ) / 2 )
           ...
           if( nisodd ) then
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_wherk( 'L', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n )
                                 
                       call stdlib_wherk( 'U', 'N', n2, k, alpha, a( n1+1, 1_ilp ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_wgemm( 'N', 'C', n2, n1, k, calpha, a( n1+1, 1_ilp ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( n1+1 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'c'
                       call stdlib_wherk( 'L', 'C', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n )
                                 
                       call stdlib_wherk( 'U', 'C', n2, k, alpha, a( 1_ilp, n1+1 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_wgemm( 'C', 'N', n2, n1, k, calpha, a( 1_ilp, n1+1 ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( n1+1 ), n )
                    end if
                 else
                    ! n is odd, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_wherk( 'L', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_wherk( 'U', 'N', n2, k, alpha, a( n2, 1_ilp ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_wgemm( 'N', 'C', n1, n2, k, calpha, a( 1_ilp, 1_ilp ),lda, a( n2, 1_ilp ), &
                                 lda, cbeta, c( 1_ilp ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'c'
                       call stdlib_wherk( 'L', 'C', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_wherk( 'U', 'C', n2, k, alpha, a( 1_ilp, n2 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_wgemm( 'C', 'N', n1, n2, k, calpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, n2 ), &
                                 lda, cbeta, c( 1_ilp ), n )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'c', uplo = 'l', and trans = 'n'
                       call stdlib_wherk( 'U', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n1 &
                                 )
                       call stdlib_wherk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp ), lda,beta, c( 2_ilp ), &
                                 n1 )
                       call stdlib_wgemm( 'N', 'C', n1, n2, k, calpha, a( 1_ilp, 1_ilp ),lda, a( n1+1, 1_ilp )&
                                 , lda, cbeta,c( n1*n1+1 ), n1 )
                    else
                       ! n is odd, transr = 'c', uplo = 'l', and trans = 'c'
                       call stdlib_wherk( 'U', 'C', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n1 &
                                 )
                       call stdlib_wherk( 'L', 'C', n2, k, alpha, a( 1_ilp, n1+1 ), lda,beta, c( 2_ilp ), &
                                 n1 )
                       call stdlib_wgemm( 'C', 'N', n1, n2, k, calpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, n1+1 )&
                                 , lda, cbeta,c( n1*n1+1 ), n1 )
                    end if
                 else
                    ! n is odd, transr = 'c', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'c', uplo = 'u', and trans = 'n'
                       call stdlib_wherk( 'U', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_wherk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_wgemm( 'N', 'C', n2, n1, k, calpha, a( n1+1, 1_ilp ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( 1_ilp ), n2 )
                    else
                       ! n is odd, transr = 'c', uplo = 'u', and trans = 'c'
                       call stdlib_wherk( 'U', 'C', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_wherk( 'L', 'C', n2, k, alpha, a( 1_ilp, n1+1 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_wgemm( 'C', 'N', n2, n1, k, calpha, a( 1_ilp, n1+1 ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( 1_ilp ), n2 )
                    end if
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_wherk( 'L', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 2_ilp ), n+&
                                 1_ilp )
                       call stdlib_wherk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( 1_ilp ), &
                                 n+1 )
                       call stdlib_wgemm( 'N', 'C', nk, nk, k, calpha, a( nk+1, 1_ilp ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( nk+2 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'c'
                       call stdlib_wherk( 'L', 'C', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 2_ilp ), n+&
                                 1_ilp )
                       call stdlib_wherk( 'U', 'C', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( 1_ilp ), &
                                 n+1 )
                       call stdlib_wgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp, nk+1 ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( nk+2 ),n+1 )
                    end if
                 else
                    ! n is even, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_wherk( 'L', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_wherk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_wgemm( 'N', 'C', nk, nk, k, calpha, a( 1_ilp, 1_ilp ),lda, a( nk+1, 1_ilp )&
                                 , lda, cbeta, c( 1_ilp ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'c'
                       call stdlib_wherk( 'L', 'C', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_wherk( 'U', 'C', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_wgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, nk+1 )&
                                 , lda, cbeta, c( 1_ilp ),n+1 )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'c', uplo = 'l', and trans = 'n'
                       call stdlib_wherk( 'U', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_wherk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( 1_ilp ), &
                                 nk )
                       call stdlib_wgemm( 'N', 'C', nk, nk, k, calpha, a( 1_ilp, 1_ilp ),lda, a( nk+1, 1_ilp )&
                                 , lda, cbeta,c( ( ( nk+1 )*nk )+1_ilp ), nk )
                    else
                       ! n is even, transr = 'c', uplo = 'l', and trans = 'c'
                       call stdlib_wherk( 'U', 'C', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_wherk( 'L', 'C', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( 1_ilp ), &
                                 nk )
                       call stdlib_wgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, nk+1 )&
                                 , lda, cbeta,c( ( ( nk+1 )*nk )+1_ilp ), nk )
                    end if
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'c', uplo = 'u', and trans = 'n'
                       call stdlib_wherk( 'U', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk*( nk+&
                                 1_ilp )+1_ilp ), nk )
                       call stdlib_wherk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_wgemm( 'N', 'C', nk, nk, k, calpha, a( nk+1, 1_ilp ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( 1_ilp ), nk )
                    else
                       ! n is even, transr = 'c', uplo = 'u', and trans = 'c'
                       call stdlib_wherk( 'U', 'C', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk*( nk+&
                                 1_ilp )+1_ilp ), nk )
                       call stdlib_wherk( 'L', 'C', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_wgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp, nk+1 ),lda, a( 1_ilp, 1_ilp )&
                                 , lda, cbeta, c( 1_ilp ), nk )
                    end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          if( m==1_ilp ) then
                             ...
                             call stdlib_qtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( 0_ilp ), m, b, &
                                       ldb )
                             call stdlib_qgemm( 'N', 'N', m2, n, m1, -one, a( m1 ),m, b, ldb, &
                                       alpha, b( m1, 0_ilp ), ldb )
                             call stdlib_qtrsm( 'L', 'U', 'T', diag, m2, n, one,a( m ), m, b( m1, &
                                       0_ilp ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 't'
                          if( m==1_ilp ) then
                             call stdlib_qtrsm( 'L', 'L', 'T', diag, m1, n, alpha,a( 0_ilp ), m, b, &
                                       ldb )
                          else
                             call stdlib_qtrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m ), m, b( &
                                       m1, 0_ilp ), ldb )
                             call stdlib_qgemm( 'T', 'N', m1, n, m2, -one, a( m1 ),m, b( m1, 0_ilp ), &
                                       ldb, alpha, b, ldb )
                             call stdlib_qtrsm( 'L', 'L', 'T', diag, m1, n, one,a( 0_ilp ), m, b, ldb &
                                       )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_qtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( m2 ), m, b, ldb &
                                    )
                          call stdlib_qgemm( 'T', 'N', m2, n, m1, -one, a( 0_ilp ), m,b, ldb, alpha, &
                                    b( m1, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'L', 'U', 'T', diag, m2, n, one,a( m1 ), m, b( m1, 0_ilp &
                                    ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_qtrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m1 ), m, b( m1, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'N', m1, n, m2, -one, a( 0_ilp ), m,b( m1, 0_ilp ), ldb,&
                                     alpha, b, ldb )
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp ) then
                             call stdlib_qtrsm( 'L', 'U', 'T', diag, m1, n, alpha,a( 0_ilp ), m1, b, &
                                       ldb )
                          else
                             call stdlib_qtrsm( 'L', 'U', 'T', diag, m1, n, alpha,a( 0_ilp ), m1, b, &
                                       ldb )
                             call stdlib_qgemm( 'T', 'N', m2, n, m1, -one,a( m1*m1 ), m1, b, ldb, &
                                       alpha,b( m1, 0_ilp ), ldb )
                             call stdlib_qtrsm( 'L', 'L', 'N', diag, m2, n, one,a( 1_ilp ), m1, b( m1,&
                                        0_ilp ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 't'
                          if( m==1_ilp ) then
                             call stdlib_qtrsm( 'L', 'U', 'N', diag, m1, n, alpha,a( 0_ilp ), m1, b, &
                                       ldb )
                          else
                             call stdlib_qtrsm( 'L', 'L', 'T', diag, m2, n, alpha,a( 1_ilp ), m1, b( &
                                       m1, 0_ilp ), ldb )
                             call stdlib_qgemm( 'N', 'N', m1, n, m2, -one,a( m1*m1 ), m1, b( m1, &
                                       0_ilp ), ldb,alpha, b, ldb )
                             call stdlib_qtrsm( 'L', 'U', 'N', diag, m1, n, one,a( 0_ilp ), m1, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_qtrsm( 'L', 'U', 'T', diag, m1, n, alpha,a( m2*m2 ), m2, b, &
                                    ldb )
                          call stdlib_qgemm( 'N', 'N', m2, n, m1, -one, a( 0_ilp ), m2,b, ldb, alpha, &
                                    b( m1, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'L', 'L', 'N', diag, m2, n, one,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_qtrsm( 'L', 'L', 'T', diag, m2, n, alpha,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp ), ldb )
                          call stdlib_qgemm( 'T', 'N', m1, n, m2, -one, a( 0_ilp ), m2,b( m1, 0_ilp ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_qtrsm( 'L', 'U', 'N', diag, m1, n, one,a( m2*m2 ), m2, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'L', 'L', 'N', diag, k, n, alpha,a( 1_ilp ), m+1, b, ldb &
                                    )
                          call stdlib_qgemm( 'N', 'N', k, n, k, -one, a( k+1 ),m+1, b, ldb, alpha,&
                                     b( k, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'L', 'U', 'T', diag, k, n, one,a( 0_ilp ), m+1, b( k, 0_ilp )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'L', 'U', 'N', diag, k, n, alpha,a( 0_ilp ), m+1, b( k, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'T', 'N', k, n, k, -one, a( k+1 ),m+1, b( k, 0_ilp ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_qtrsm( 'L', 'L', 'T', diag, k, n, one,a( 1_ilp ), m+1, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'L', 'L', 'N', diag, k, n, alpha,a( k+1 ), m+1, b, &
                                    ldb )
                          call stdlib_qgemm( 'T', 'N', k, n, k, -one, a( 0_ilp ), m+1,b, ldb, alpha, &
                                    b( k, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'L', 'U', 'T', diag, k, n, one,a( k ), m+1, b( k, 0_ilp )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'L', 'U', 'N', diag, k, n, alpha,a( k ), m+1, b( k, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'N', k, n, k, -one, a( 0_ilp ), m+1,b( k, 0_ilp ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_qtrsm( 'L', 'L', 'T', diag, k, n, one,a( k+1 ), m+1, b, ldb &
                                    )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          call stdlib_qgemm( 'T', 'N', k, n, k, -one,a( k*( k+1 ) ), k, b, ldb, &
                                    alpha,b( k, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'L', 'L', 'N', diag, k, n, one,a( 0_ilp ), k, b( k, 0_ilp ), &
                                    ldb )
                       else
                          ! side  ='l', n is even, transr = 't', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'L', 'L', 'T', diag, k, n, alpha,a( 0_ilp ), k, b( k, 0_ilp )&
                                    , ldb )
                          call stdlib_qgemm( 'N', 'N', k, n, k, -one,a( k*( k+1 ) ), k, b( k, 0_ilp ),&
                                     ldb,alpha, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 't', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'L', 'U', 'T', diag, k, n, alpha,a( k*( k+1 ) ), k, &
                                    b, ldb )
                          call stdlib_qgemm( 'N', 'N', k, n, k, -one, a( 0_ilp ), k, b,ldb, alpha, b( &
                                    k, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'L', 'L', 'N', diag, k, n, one,a( k*k ), k, b( k, 0_ilp )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 't', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'L', 'L', 'T', diag, k, n, alpha,a( k*k ), k, b( k, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'T', 'N', k, n, k, -one, a( 0_ilp ), k,b( k, 0_ilp ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_qtrsm( 'L', 'U', 'N', diag, k, n, one,a( k*( k+1 ) ), k, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, n2, alpha,a( n ), n, b( 0_ilp, &
                                    n1 ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, n1, n2, -one, b( 0_ilp, n1 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, n1, one,a( 0_ilp ), n, b( 0_ilp, 0_ilp ),&
                                     ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 't'
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, n1, alpha,a( 0_ilp ), n, b( 0_ilp, 0_ilp &
                                    ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, n2, n1, -one, b( 0_ilp, 0_ilp ),ldb, a( n1 ), n,&
                                     alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, n2, one,a( n ), n, b( 0_ilp, n1 )&
                                    , ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, n1, alpha,a( n2 ), n, b( 0_ilp, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, n2, n1, -one, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), n, &
                                    alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, n2, one,a( n1 ), n, b( 0_ilp, n1 &
                                    ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, n2, alpha,a( n1 ), n, b( 0_ilp, &
                                    n1 ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, n1, n2, -one, b( 0_ilp, n1 ),ldb, a( 0_ilp ), n,&
                                     alpha, b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, n1, one,a( n2 ), n, b( 0_ilp, 0_ilp )&
                                    , ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( 1_ilp ), n1, b( 0_ilp, &
                                    n1 ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, n1, n2, -one, b( 0_ilp, n1 ),ldb, a( n1*n1 )&
                                    , n1, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, n1, one,a( 0_ilp ), n1, b( 0_ilp, 0_ilp )&
                                    , ldb )
                       else
                          ! side  ='r', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 't'
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( 0_ilp ), n1, b( 0_ilp, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, n2, n1, -one, b( 0_ilp, 0_ilp ),ldb, a( n1*n1 ),&
                                     n1, alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, n2, one,a( 1_ilp ), n1, b( 0_ilp, n1 &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 't', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( n2*n2 ), n2, b( &
                                    0_ilp, 0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, n2, n1, -one, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), n2,&
                                     alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, n2, one,a( n1*n2 ), n2, b( 0_ilp,&
                                     n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( n1*n2 ), n2, b( &
                                    0_ilp, n1 ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, n1, n2, -one, b( 0_ilp, n1 ),ldb, a( 0_ilp ), &
                                    n2, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, n1, one,a( n2*n2 ), n2, b( 0_ilp,&
                                     0_ilp ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, k, alpha,a( 0_ilp ), n+1, b( 0_ilp, &
                                    k ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, k, k, -one, b( 0_ilp, k ),ldb, a( k+1 ), n+&
                                    1_ilp, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, k, one,a( 1_ilp ), n+1, b( 0_ilp, 0_ilp )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, k, alpha,a( 1_ilp ), n+1, b( 0_ilp, &
                                    0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, k, k, -one, b( 0_ilp, 0_ilp ),ldb, a( k+1 ), n+&
                                    1_ilp, alpha, b( 0_ilp, k ),ldb )
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, k, one,a( 0_ilp ), n+1, b( 0_ilp, k )&
                                    , ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, k, alpha,a( k+1 ), n+1, b( 0_ilp,&
                                     0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, k, k, -one, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), n+1, &
                                    alpha, b( 0_ilp, k ),ldb )
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, k, one,a( k ), n+1, b( 0_ilp, k )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, k, alpha,a( k ), n+1, b( 0_ilp, &
                                    k ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, k, k, -one, b( 0_ilp, k ),ldb, a( 0_ilp ), n+1, &
                                    alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, k, one,a( k+1 ), n+1, b( 0_ilp, &
                                    0_ilp ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 't', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, k, alpha,a( 0_ilp ), k, b( 0_ilp, k )&
                                    , ldb )
                          call stdlib_qgemm( 'N', 'T', m, k, k, -one, b( 0_ilp, k ),ldb, a( ( k+1 )*k &
                                    ), k, alpha,b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, k, one,a( k ), k, b( 0_ilp, 0_ilp ), &
                                    ldb )
                       else
                          ! side  ='r', n is even, transr = 't', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, k, alpha,a( k ), k, b( 0_ilp, 0_ilp )&
                                    , ldb )
                          call stdlib_qgemm( 'N', 'N', m, k, k, -one, b( 0_ilp, 0_ilp ),ldb, a( ( k+1 )*k &
                                    ), k, alpha,b( 0_ilp, k ), ldb )
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, k, one,a( 0_ilp ), k, b( 0_ilp, k ), &
                                    ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 't', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 't', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_qtrsm( 'R', 'U', 'N', diag, m, k, alpha,a( ( k+1 )*k ), k, &
                                    b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_qgemm( 'N', 'T', m, k, k, -one, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), k, &
                                    alpha, b( 0_ilp, k ), ldb )
                          call stdlib_qtrsm( 'R', 'L', 'T', diag, m, k, one,a( k*k ), k, b( 0_ilp, k )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 't', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_qtrsm( 'R', 'L', 'N', diag, m, k, alpha,a( k*k ), k, b( 0_ilp, &
                                    k ), ldb )
                          call stdlib_qgemm( 'N', 'N', m, k, k, -one, b( 0_ilp, k ),ldb, a( 0_ilp ), k, &
                                    alpha, b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_qtrsm( 'R', 'U', 'T', diag, m, k, one,a( ( k+1 )*k ), k, b( &
                                    0_ilp, 0_ilp ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          if( m==1_ilp ) then
                             ...
                             call stdlib_wtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( 0_ilp ), m, b, &
                                       ldb )
                             call stdlib_wgemm( 'N', 'N', m2, n, m1, -cone, a( m1 ),m, b, ldb, &
                                       alpha, b( m1, 0_ilp ), ldb )
                             call stdlib_wtrsm( 'L', 'U', 'C', diag, m2, n, cone,a( m ), m, b( m1,&
                                        0_ilp ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'c'
                          if( m==1_ilp ) then
                             call stdlib_wtrsm( 'L', 'L', 'C', diag, m1, n, alpha,a( 0_ilp ), m, b, &
                                       ldb )
                          else
                             call stdlib_wtrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m ), m, b( &
                                       m1, 0_ilp ), ldb )
                             call stdlib_wgemm( 'C', 'N', m1, n, m2, -cone, a( m1 ),m, b( m1, 0_ilp ),&
                                        ldb, alpha, b, ldb )
                             call stdlib_wtrsm( 'L', 'L', 'C', diag, m1, n, cone,a( 0_ilp ), m, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_wtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( m2 ), m, b, ldb &
                                    )
                          call stdlib_wgemm( 'C', 'N', m2, n, m1, -cone, a( 0_ilp ), m,b, ldb, alpha, &
                                    b( m1, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'L', 'U', 'C', diag, m2, n, cone,a( m1 ), m, b( m1, &
                                    0_ilp ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_wtrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m1 ), m, b( m1, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'N', m1, n, m2, -cone, a( 0_ilp ), m,b( m1, 0_ilp ), &
                                    ldb, alpha, b, ldb )
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp ) then
                             call stdlib_wtrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( 0_ilp ), m1, b, &
                                       ldb )
                          else
                             call stdlib_wtrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( 0_ilp ), m1, b, &
                                       ldb )
                             call stdlib_wgemm( 'C', 'N', m2, n, m1, -cone,a( m1*m1 ), m1, b, ldb,&
                                        alpha,b( m1, 0_ilp ), ldb )
                             call stdlib_wtrsm( 'L', 'L', 'N', diag, m2, n, cone,a( 1_ilp ), m1, b( &
                                       m1, 0_ilp ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'c'
                          if( m==1_ilp ) then
                             call stdlib_wtrsm( 'L', 'U', 'N', diag, m1, n, alpha,a( 0_ilp ), m1, b, &
                                       ldb )
                          else
                             call stdlib_wtrsm( 'L', 'L', 'C', diag, m2, n, alpha,a( 1_ilp ), m1, b( &
                                       m1, 0_ilp ), ldb )
                             call stdlib_wgemm( 'N', 'N', m1, n, m2, -cone,a( m1*m1 ), m1, b( m1, &
                                       0_ilp ), ldb,alpha, b, ldb )
                             call stdlib_wtrsm( 'L', 'U', 'N', diag, m1, n, cone,a( 0_ilp ), m1, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_wtrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( m2*m2 ), m2, b, &
                                    ldb )
                          call stdlib_wgemm( 'N', 'N', m2, n, m1, -cone, a( 0_ilp ), m2,b, ldb, alpha,&
                                     b( m1, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'L', 'L', 'N', diag, m2, n, cone,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_wtrsm( 'L', 'L', 'C', diag, m2, n, alpha,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp ), ldb )
                          call stdlib_wgemm( 'C', 'N', m1, n, m2, -cone, a( 0_ilp ), m2,b( m1, 0_ilp ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_wtrsm( 'L', 'U', 'N', diag, m1, n, cone,a( m2*m2 ), m2, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'L', 'L', 'N', diag, k, n, alpha,a( 1_ilp ), m+1, b, ldb &
                                    )
                          call stdlib_wgemm( 'N', 'N', k, n, k, -cone, a( k+1 ),m+1, b, ldb, &
                                    alpha, b( k, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'L', 'U', 'C', diag, k, n, cone,a( 0_ilp ), m+1, b( k, 0_ilp &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'L', 'U', 'N', diag, k, n, alpha,a( 0_ilp ), m+1, b( k, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'C', 'N', k, n, k, -cone, a( k+1 ),m+1, b( k, 0_ilp ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_wtrsm( 'L', 'L', 'C', diag, k, n, cone,a( 1_ilp ), m+1, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'L', 'L', 'N', diag, k, n, alpha,a( k+1 ), m+1, b, &
                                    ldb )
                          call stdlib_wgemm( 'C', 'N', k, n, k, -cone, a( 0_ilp ), m+1,b, ldb, alpha, &
                                    b( k, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'L', 'U', 'C', diag, k, n, cone,a( k ), m+1, b( k, 0_ilp &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'L', 'U', 'N', diag, k, n, alpha,a( k ), m+1, b( k, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'N', k, n, k, -cone, a( 0_ilp ), m+1,b( k, 0_ilp ), ldb,&
                                     alpha, b, ldb )
                          call stdlib_wtrsm( 'L', 'L', 'C', diag, k, n, cone,a( k+1 ), m+1, b, &
                                    ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          call stdlib_wgemm( 'C', 'N', k, n, k, -cone,a( k*( k+1 ) ), k, b, ldb, &
                                    alpha,b( k, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'L', 'L', 'N', diag, k, n, cone,a( 0_ilp ), k, b( k, 0_ilp ),&
                                     ldb )
                       else
                          ! side  ='l', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'L', 'L', 'C', diag, k, n, alpha,a( 0_ilp ), k, b( k, 0_ilp )&
                                    , ldb )
                          call stdlib_wgemm( 'N', 'N', k, n, k, -cone,a( k*( k+1 ) ), k, b( k, 0_ilp )&
                                    , ldb,alpha, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'L', 'U', 'C', diag, k, n, alpha,a( k*( k+1 ) ), k, &
                                    b, ldb )
                          call stdlib_wgemm( 'N', 'N', k, n, k, -cone, a( 0_ilp ), k, b,ldb, alpha, b(&
                                     k, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'L', 'L', 'N', diag, k, n, cone,a( k*k ), k, b( k, 0_ilp &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'L', 'L', 'C', diag, k, n, alpha,a( k*k ), k, b( k, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'C', 'N', k, n, k, -cone, a( 0_ilp ), k,b( k, 0_ilp ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_wtrsm( 'L', 'U', 'N', diag, k, n, cone,a( k*( k+1 ) ), k, b,&
                                     ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, n2, alpha,a( n ), n, b( 0_ilp, &
                                    n1 ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, n1, n2, -cone, b( 0_ilp, n1 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, n1, cone,a( 0_ilp ), n, b( 0_ilp, 0_ilp )&
                                    , ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'c'
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, n1, alpha,a( 0_ilp ), n, b( 0_ilp, 0_ilp &
                                    ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, n2, n1, -cone, b( 0_ilp, 0_ilp ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, n2, cone,a( n ), n, b( 0_ilp, n1 &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, n1, alpha,a( n2 ), n, b( 0_ilp, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, n2, n1, -cone, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), n,&
                                     alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, n2, cone,a( n1 ), n, b( 0_ilp, &
                                    n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, n2, alpha,a( n1 ), n, b( 0_ilp, &
                                    n1 ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, n1, n2, -cone, b( 0_ilp, n1 ),ldb, a( 0_ilp ), &
                                    n, alpha, b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, n1, cone,a( n2 ), n, b( 0_ilp, 0_ilp &
                                    ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( 1_ilp ), n1, b( 0_ilp, &
                                    n1 ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, n1, n2, -cone, b( 0_ilp, n1 ),ldb, a( n1*n1 &
                                    ), n1, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, n1, cone,a( 0_ilp ), n1, b( 0_ilp, 0_ilp &
                                    ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'c'
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( 0_ilp ), n1, b( 0_ilp, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, n2, n1, -cone, b( 0_ilp, 0_ilp ),ldb, a( n1*n1 )&
                                    , n1, alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, n2, cone,a( 1_ilp ), n1, b( 0_ilp, &
                                    n1 ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'c', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( n2*n2 ), n2, b( &
                                    0_ilp, 0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, n2, n1, -cone, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), &
                                    n2, alpha, b( 0_ilp, n1 ),ldb )
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, n2, cone,a( n1*n2 ), n2, b( &
                                    0_ilp, n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( n1*n2 ), n2, b( &
                                    0_ilp, n1 ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, n1, n2, -cone, b( 0_ilp, n1 ),ldb, a( 0_ilp ), &
                                    n2, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, n1, cone,a( n2*n2 ), n2, b( &
                                    0_ilp, 0_ilp ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, k, alpha,a( 0_ilp ), n+1, b( 0_ilp, &
                                    k ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp, k ),ldb, a( k+1 ), n+&
                                    1_ilp, alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, k, cone,a( 1_ilp ), n+1, b( 0_ilp, 0_ilp &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, k, alpha,a( 1_ilp ), n+1, b( 0_ilp, &
                                    0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp, 0_ilp ),ldb, a( k+1 ), n+&
                                    1_ilp, alpha, b( 0_ilp, k ),ldb )
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, k, cone,a( 0_ilp ), n+1, b( 0_ilp, k &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, k, alpha,a( k+1 ), n+1, b( 0_ilp,&
                                     0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), n+1,&
                                     alpha, b( 0_ilp, k ),ldb )
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, k, cone,a( k ), n+1, b( 0_ilp, k &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, k, alpha,a( k ), n+1, b( 0_ilp, &
                                    k ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp, k ),ldb, a( 0_ilp ), n+1,&
                                     alpha, b( 0_ilp, 0_ilp ),ldb )
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, k, cone,a( k+1 ), n+1, b( 0_ilp, &
                                    0_ilp ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, k, alpha,a( 0_ilp ), k, b( 0_ilp, k )&
                                    , ldb )
                          call stdlib_wgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp, k ),ldb, a( ( k+1 )&
                                    *k ), k, alpha,b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, k, cone,a( k ), k, b( 0_ilp, 0_ilp ),&
                                     ldb )
                       else
                          ! side  ='r', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, k, alpha,a( k ), k, b( 0_ilp, 0_ilp )&
                                    , ldb )
                          call stdlib_wgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp, 0_ilp ),ldb, a( ( k+1 )&
                                    *k ), k, alpha,b( 0_ilp, k ), ldb )
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, k, cone,a( 0_ilp ), k, b( 0_ilp, k ),&
                                     ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'c', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_wtrsm( 'R', 'U', 'N', diag, m, k, alpha,a( ( k+1 )*k ), k, &
                                    b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_wgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp, 0_ilp ),ldb, a( 0_ilp ), k, &
                                    alpha, b( 0_ilp, k ), ldb )
                          call stdlib_wtrsm( 'R', 'L', 'C', diag, m, k, cone,a( k*k ), k, b( 0_ilp, k &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_wtrsm( 'R', 'L', 'N', diag, m, k, alpha,a( k*k ), k, b( 0_ilp, &
                                    k ), ldb )
                          call stdlib_wgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp, k ),ldb, a( 0_ilp ), k, &
                                    alpha, b( 0_ilp, 0_ilp ), ldb )
                          call stdlib_wtrsm( 'R', 'U', 'C', diag, m, k, cone,a( ( k+1 )*k ), k, b(&
                                     0_ilp, 0_ilp ), ldb )
                       end if
                    end if
                 end if
     ...
     !! matrix in the second case.
        ...
        ! =====================================================================
           ...
           ! quick return if possible.
           ! the quick return case: ((alpha==0).and.(beta/=zero)) is not
           ! done (it is in stdlib_qsyrk for example) and left in the general case.
           if( ( n==0_ilp ) .or. ( ( ( alpha==zero ) .or. ( k==0_ilp ) ) .and.( beta==one ) ) )&
                     return
           if( ( alpha==zero ) .and. ( beta==zero ) ) then
              do j = 1, ( ( n*( n+1 ) ) / 2 )
           ...
           if( nisodd ) then
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_qsyrk( 'L', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n )
                                 
                       call stdlib_qsyrk( 'U', 'N', n2, k, alpha, a( n1+1, 1_ilp ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_qgemm( 'N', 'T', n2, n1, k, alpha, a( n1+1, 1_ilp ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( n1+1 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 't'
                       call stdlib_qsyrk( 'L', 'T', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n )
                                 
                       call stdlib_qsyrk( 'U', 'T', n2, k, alpha, a( 1_ilp, n1+1 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_qgemm( 'T', 'N', n2, n1, k, alpha, a( 1_ilp, n1+1 ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( n1+1 ), n )
                    end if
                 else
                    ! n is odd, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_qsyrk( 'L', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_qsyrk( 'U', 'N', n2, k, alpha, a( n2, 1_ilp ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_qgemm( 'N', 'T', n1, n2, k, alpha, a( 1_ilp, 1_ilp ),lda, a( n2, 1_ilp ), &
                                 lda, beta, c( 1_ilp ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 't'
                       call stdlib_qsyrk( 'L', 'T', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_qsyrk( 'U', 'T', n2, k, alpha, a( 1_ilp, n2 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_qgemm( 'T', 'N', n1, n2, k, alpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, n2 ), &
                                 lda, beta, c( 1_ilp ), n )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 't', uplo = 'l', and trans = 'n'
                       call stdlib_qsyrk( 'U', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n1 &
                                 )
                       call stdlib_qsyrk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp ), lda,beta, c( 2_ilp ), &
                                 n1 )
                       call stdlib_qgemm( 'N', 'T', n1, n2, k, alpha, a( 1_ilp, 1_ilp ),lda, a( n1+1, 1_ilp ),&
                                  lda, beta,c( n1*n1+1 ), n1 )
                    else
                       ! n is odd, transr = 't', uplo = 'l', and trans = 't'
                       call stdlib_qsyrk( 'U', 'T', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 1_ilp ), n1 &
                                 )
                       call stdlib_qsyrk( 'L', 'T', n2, k, alpha, a( 1_ilp, n1+1 ), lda,beta, c( 2_ilp ), &
                                 n1 )
                       call stdlib_qgemm( 'T', 'N', n1, n2, k, alpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, n1+1 ),&
                                  lda, beta,c( n1*n1+1 ), n1 )
                    end if
                 else
                    ! n is odd, transr = 't', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 't', uplo = 'u', and trans = 'n'
                       call stdlib_qsyrk( 'U', 'N', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_qsyrk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_qgemm( 'N', 'T', n2, n1, k, alpha, a( n1+1, 1_ilp ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( 1_ilp ), n2 )
                    else
                       ! n is odd, transr = 't', uplo = 'u', and trans = 't'
                       call stdlib_qsyrk( 'U', 'T', n1, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_qsyrk( 'L', 'T', n2, k, alpha, a( 1_ilp, n1+1 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_qgemm( 'T', 'N', n2, n1, k, alpha, a( 1_ilp, n1+1 ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( 1_ilp ), n2 )
                    end if
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_qsyrk( 'L', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 2_ilp ), n+&
                                 1_ilp )
                       call stdlib_qsyrk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( 1_ilp ), &
                                 n+1 )
                       call stdlib_qgemm( 'N', 'T', nk, nk, k, alpha, a( nk+1, 1_ilp ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( nk+2 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'l', and trans = 't'
                       call stdlib_qsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( 2_ilp ), n+&
                                 1_ilp )
                       call stdlib_qsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( 1_ilp ), &
                                 n+1 )
                       call stdlib_qgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp, nk+1 ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( nk+2 ),n+1 )
                    end if
                 else
                    ! n is even, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_qsyrk( 'L', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_qsyrk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_qgemm( 'N', 'T', nk, nk, k, alpha, a( 1_ilp, 1_ilp ),lda, a( nk+1, 1_ilp ),&
                                  lda, beta, c( 1_ilp ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'u', and trans = 't'
                       call stdlib_qsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_qsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_qgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, nk+1 ),&
                                  lda, beta, c( 1_ilp ),n+1 )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 't', uplo = 'l', and trans = 'n'
                       call stdlib_qsyrk( 'U', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_qsyrk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( 1_ilp ), &
                                 nk )
                       call stdlib_qgemm( 'N', 'T', nk, nk, k, alpha, a( 1_ilp, 1_ilp ),lda, a( nk+1, 1_ilp ),&
                                  lda, beta,c( ( ( nk+1 )*nk )+1_ilp ), nk )
                    else
                       ! n is even, transr = 't', uplo = 'l', and trans = 't'
                       call stdlib_qsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_qsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( 1_ilp ), &
                                 nk )
                       call stdlib_qgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp, 1_ilp ),lda, a( 1_ilp, nk+1 ),&
                                  lda, beta,c( ( ( nk+1 )*nk )+1_ilp ), nk )
                    end if
                    ...
                    if( notrans ) then
                       ! n is even, transr = 't', uplo = 'u', and trans = 'n'
                       call stdlib_qsyrk( 'U', 'N', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk*( nk+&
                                 1_ilp )+1_ilp ), nk )
                       call stdlib_qsyrk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_qgemm( 'N', 'T', nk, nk, k, alpha, a( nk+1, 1_ilp ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( 1_ilp ), nk )
                    else
                       ! n is even, transr = 't', uplo = 'u', and trans = 't'
                       call stdlib_qsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp, 1_ilp ), lda,beta, c( nk*( nk+&
                                 1_ilp )+1_ilp ), nk )
                       call stdlib_qsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp, nk+1 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_qgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp, nk+1 ),lda, a( 1_ilp, 1_ilp ),&
                                  lda, beta, c( 1_ilp ), nk )
                    end if
