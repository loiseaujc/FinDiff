module stdlib_linalg
  ...
  interface chol
    ...
    !!     
     ...
     pure module function stdlib_linalg_q_cholesky_fun(a,lower,other_zeroed) result(c)
         !> Input matrix a[m,n]
         real(qp), intent(in) :: a(:,:)
         !> [optional] is the lower or upper triangular factor required? Default = lower
         logical(lk), optional, intent(in) :: lower
     ...
     end function stdlib_linalg_q_cholesky_fun
     ...
     pure module function stdlib_linalg_w_cholesky_fun(a,lower,other_zeroed) result(c)
         !> Input matrix a[m,n]
     ...
     end function stdlib_linalg_w_cholesky_fun
  end interface chol  
  ...
  interface cholesky
    ...
    !!         
     ...
     pure module subroutine stdlib_linalg_q_cholesky_inplace(a,lower,other_zeroed,err) 
         !> Input matrix a[m,n]
     ...
     pure module subroutine stdlib_linalg_q_cholesky(a,c,lower,other_zeroed,err) 
         !> Input matrix a[n,n]
         real(qp), intent(in) :: a(:,:)
         !> Output matrix with Cholesky factors c[n,n]
     ...
     pure module subroutine stdlib_linalg_w_cholesky_inplace(a,lower,other_zeroed,err) 
         !> Input matrix a[m,n]
     ...
     pure module subroutine stdlib_linalg_w_cholesky(a,c,lower,other_zeroed,err) 
         !> Input matrix a[n,n]
         complex(qp), intent(in) :: a(:,:)
         !> Output matrix with Cholesky factors c[n,n]
  ...
  interface diag
    ...
    !! diag-create-a-diagonal-array-or-extract-the-diagonal-elements-of-an-array))
      ...
      module pure function diag_rqp(v) result(res)
        real(qp), intent(in) :: v(:)
      ...
      module pure function diag_cqp(v) result(res)
      ...
      module pure function diag_rqp_k(v,k) result(res)
        real(qp), intent(in) :: v(:)
        integer, intent(in) :: k
      ...
      module pure function diag_cqp_k(v,k) result(res)
        complex(qp), intent(in) :: v(:)
        integer, intent(in) :: k
      ...
      module pure function diag_rqp_mat(A) result(res)
        real(qp), intent(in) :: A(:,:)
      ...
      module pure function diag_cqp_mat(A) result(res)
        complex(qp), intent(in) :: A(:,:)
      ...
      module pure function diag_rqp_mat_k(A,k) result(res)
        real(qp), intent(in) :: A(:,:)
        integer, intent(in) :: k
      ...
      module pure function diag_cqp_mat_k(A,k) result(res)
        complex(qp), intent(in) :: A(:,:)
        integer, intent(in) :: k
  ...
  interface eye
    ...
    !! ([Specification](../page/specs/stdlib_linalg.html#eye-construct-the-identity-matrix))    
      ...
      module procedure eye_rqp
      module procedure eye_csp
      module procedure eye_cdp
      module procedure eye_cqp
  ...
  interface hermitian
    ...
    pure module function hermitian_rqp(a) result(ah)
        real(qp), intent(in) :: a(:,:)
        real(qp) :: ah(size(a, 2), size(a, 1))
    end function hermitian_rqp
    ...
    pure module function hermitian_cqp(a) result(ah)
        complex(qp), intent(in) :: a(:,:)
        complex(qp) :: ah(size(a, 2), size(a, 1))
    end function hermitian_cqp
  ...
  interface qr
    ...
    !!     
      ...
      pure module subroutine stdlib_linalg_q_qr(a,q,r,overwrite_a,storage,err) 
         !> Input matrix a[m,n]
         real(qp), intent(inout), target :: a(:,:)
         !> Orthogonal matrix Q ([m,m], or [m,k] if reduced)
      ...
      pure module subroutine stdlib_linalg_w_qr(a,q,r,overwrite_a,storage,err) 
         !> Input matrix a[m,n]
         complex(qp), intent(inout), target :: a(:,:)
         !> Orthogonal matrix Q ([m,m], or [m,k] if reduced)
  ...
  interface qr_space
    ...
    !!     
      ...
      pure module subroutine get_qr_q_workspace(a,lwork,err)
         !> Input matrix a[m,n]
         real(qp), intent(in), target :: a(:,:)
         !> Minimum workspace size for both operations
         integer(ilp), intent(out) :: lwork
      ...
      pure module subroutine get_qr_w_workspace(a,lwork,err)
         !> Input matrix a[m,n]
         complex(qp), intent(in), target :: a(:,:)
         !> Minimum workspace size for both operations
         integer(ilp), intent(out) :: lwork
  ...
  interface schur
    ...
    !! 
      ...
      module subroutine stdlib_linalg_q_schur(a, t, z, eigvals, overwrite_a, storage, err)
         !> Input matrix a[m,m]
         real(qp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
      ...
      ! Schur decomposition subroutine: real eigenvalue interface
      module subroutine stdlib_linalg_real_eig_q_schur(a,t,z,eigvals,overwrite_a,storage,err)
         !> Input matrix a[m,m]
         real(qp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
         real(qp), intent(out), contiguous, target :: t(:,:)
         ...
         !> [optional] State return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err        
      end subroutine stdlib_linalg_real_eig_q_schur 
      ...
      module subroutine stdlib_linalg_w_schur(a, t, z, eigvals, overwrite_a, storage, err)
         !> Input matrix a[m,m]
         complex(qp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
      ...
      ! Schur decomposition subroutine: real eigenvalue interface
      module subroutine stdlib_linalg_real_eig_w_schur(a,t,z,eigvals,overwrite_a,storage,err)
         !> Input matrix a[m,m]
         complex(qp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
         complex(qp), intent(out), contiguous, target :: t(:,:)
         ...
         !> [optional] State return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err        
      end subroutine stdlib_linalg_real_eig_w_schur 
  end interface schur
  ...
  interface schur_space
    ...
    !!     
      ...
      module subroutine get_schur_q_workspace(a,lwork,err)
         !> Input matrix a[m,m]
         real(qp), intent(in), target :: a(:,:)
         !> Minimum workspace size for the decomposition operation
         integer(ilp), intent(out) :: lwork
      ...
      module subroutine get_schur_w_workspace(a,lwork,err)
         !> Input matrix a[m,m]
         complex(qp), intent(in), target :: a(:,:)
         !> Minimum workspace size for the decomposition operation
         integer(ilp), intent(out) :: lwork
  ...
  interface inv
    ...
    module function stdlib_linalg_inverse_q(a,err) result(inva)
         !> Input matrix a[n,n]
         real(qp), intent(in) :: a(:,:)
         !> Output matrix inverse
    ...
    module function stdlib_linalg_inverse_w(a,err) result(inva)
         !> Input matrix a[n,n]
         complex(qp), intent(in) :: a(:,:)
         !> Output matrix inverse
  ...
  interface invert
    ...
    module subroutine stdlib_linalg_invert_inplace_q(a,pivot,err)
         !> Input matrix a[n,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_invert_inplace_q
    ! Compute the square matrix inverse of a
    module subroutine stdlib_linalg_invert_split_q(a,inva,pivot,err)
         !> Input matrix a[n,n].
         real(qp), intent(in) :: a(:,:)
         !> Inverse matrix a[n,n]. 
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err    
    end subroutine stdlib_linalg_invert_split_q
    ...
    module subroutine stdlib_linalg_invert_inplace_w(a,pivot,err)
         !> Input matrix a[n,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_invert_inplace_w
    ! Compute the square matrix inverse of a
    module subroutine stdlib_linalg_invert_split_w(a,inva,pivot,err)
         !> Input matrix a[n,n].
         complex(qp), intent(in) :: a(:,:)
         !> Inverse matrix a[n,n]. 
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err    
    end subroutine stdlib_linalg_invert_split_w
  ...
  interface operator(.inv.)
    ...
    module function stdlib_linalg_inverse_q_operator(a) result(inva)
         !> Input matrix a[n,n]
         real(qp), intent(in) :: a(:,:)
         !> Result matrix
         real(qp), allocatable :: inva(:,:)        
    ...
    module function stdlib_linalg_inverse_w_operator(a) result(inva)
         !> Input matrix a[n,n]
         complex(qp), intent(in) :: a(:,:)
         !> Result matrix
         complex(qp), allocatable :: inva(:,:)        
  ...
  interface pinv
    ...
    module function stdlib_linalg_pseudoinverse_q(a,rtol,err) result(pinva)
        !> Input matrix a[m,n]
        real(qp), intent(in), target :: a(:,:)
        !> [optional] Relative tolerance for singular value cutoff
    ...
    module function stdlib_linalg_pseudoinverse_w(a,rtol,err) result(pinva)
        !> Input matrix a[m,n]
        complex(qp), intent(in), target :: a(:,:)
        !> [optional] Relative tolerance for singular value cutoff
        real(qp), optional, intent(in) :: rtol         
  ...
  interface pseudoinvert
    ...
    module subroutine stdlib_linalg_pseudoinvert_q(a,pinva,rtol,err)
        !> Input matrix a[m,n]
        real(qp), intent(inout) :: a(:,:)
        !> Output pseudo-inverse matrix [n,m]
        real(qp), intent(out) :: pinva(:,:)
        !> [optional] Relative tolerance for singular value cutoff
        real(qp), optional, intent(in) :: rtol
        !> [optional] State return flag. On error if not requested, the code will stop
        type(linalg_state_type), optional, intent(out) :: err
    ...
    module subroutine stdlib_linalg_pseudoinvert_w(a,pinva,rtol,err)
        !> Input matrix a[m,n]
        complex(qp), intent(inout) :: a(:,:)
        !> Output pseudo-inverse matrix [n,m]
        complex(qp), intent(out) :: pinva(:,:)
        !> [optional] Relative tolerance for singular value cutoff
        real(qp), optional, intent(in) :: rtol
        !> [optional] State return flag. On error if not requested, the code will stop
        type(linalg_state_type), optional, intent(out) :: err
  ...
  interface operator(.pinv.)
    ...
    module function stdlib_linalg_pinv_q_operator(a) result(pinva)
         !> Input matrix a[m,n]
         real(qp), intent(in), target :: a(:,:)
         !> Result pseudo-inverse matrix
         real(qp) :: pinva(size(a,2,kind=ilp),size(a,1,kind=ilp))
    ...
    module function stdlib_linalg_pinv_w_operator(a) result(pinva)
         !> Input matrix a[m,n]
         complex(qp), intent(in), target :: a(:,:)
         !> Result pseudo-inverse matrix
         complex(qp) :: pinva(size(a,2,kind=ilp),size(a,1,kind=ilp))
  ...
  interface eig    
    ...
    module subroutine stdlib_linalg_eig_standard_q(a,lambda,right,left, &
                                                      overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_standard_q

    module subroutine stdlib_linalg_real_eig_standard_q(a,lambda,right,left, &
                                                           overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_standard_q
    module subroutine stdlib_linalg_eig_generalized_q(a,b,lambda,right,left, &
                                                      overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_generalized_q

    module subroutine stdlib_linalg_real_eig_generalized_q(a,b,lambda,right,left, &
                                                           overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_generalized_q
    ...
    module subroutine stdlib_linalg_eig_standard_w(a,lambda,right,left, &
                                                      overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_standard_w

    module subroutine stdlib_linalg_real_eig_standard_w(a,lambda,right,left, &
                                                           overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_standard_w
    module subroutine stdlib_linalg_eig_generalized_w(a,b,lambda,right,left, &
                                                      overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         complex(qp), intent(inout), target :: a(:,:)
         !> Generalized problem matrix B[n,n]
         complex(qp), intent(inout), target :: b(:,:)
         !> Array of eigenvalues
         complex(qp), intent(out) :: lambda(:)
         !> The columns of RIGHT contain the right eigenvectors of A
         complex(qp), optional, intent(out), target :: right(:,:)
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_generalized_w

    module subroutine stdlib_linalg_real_eig_generalized_w(a,b,lambda,right,left, &
                                                           overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_generalized_w
  end interface eig
  ...
  interface eigvals
    ...
    module function stdlib_linalg_eigvals_standard_q(a,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
    ...
    end function stdlib_linalg_eigvals_standard_q
    
    module function stdlib_linalg_eigvals_noerr_standard_q(a) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         real(qp), intent(in), dimension(:,:), target :: a 
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_standard_q
    module function stdlib_linalg_eigvals_generalized_q(a,b,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         real(qp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)        
    end function stdlib_linalg_eigvals_generalized_q
    
    module function stdlib_linalg_eigvals_noerr_generalized_q(a,b) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         real(qp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_generalized_q
    ...
    module function stdlib_linalg_eigvals_standard_w(a,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         ...
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)        
    end function stdlib_linalg_eigvals_standard_w
    
    module function stdlib_linalg_eigvals_noerr_standard_w(a) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         complex(qp), intent(in), dimension(:,:), target :: a 
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_standard_w
    module function stdlib_linalg_eigvals_generalized_w(a,b,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         complex(qp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)        
    end function stdlib_linalg_eigvals_generalized_w
    
    module function stdlib_linalg_eigvals_noerr_generalized_w(a,b) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         complex(qp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(qp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_generalized_w
  ...
  interface eigh
    ...
    module subroutine stdlib_linalg_eigh_q(a,lambda,vectors,upper_a,overwrite_a,err)
     !! Eigendecomposition of a real symmetric or complex Hermitian matrix A returning an array `lambda` 
     !! of eigenvalues, and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         real(qp), intent(inout), target :: a(:,:)
    ...
    module subroutine stdlib_linalg_eigh_w(a,lambda,vectors,upper_a,overwrite_a,err)
     !! Eigendecomposition of a real symmetric or complex Hermitian matrix A returning an array `lambda` 
     !! of eigenvalues, and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         complex(qp), intent(inout), target :: a(:,:)
  ...
  interface eigvalsh
    ...
    module function stdlib_linalg_eigvalsh_q(a,upper_a,err) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         !> Input matrix A[m,n]
         real(qp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
    ...
    module function stdlib_linalg_eigvalsh_noerr_q(a,upper_a) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A        
         !> Input matrix A[m,n]
         real(qp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
    ...
    module function stdlib_linalg_eigvalsh_w(a,upper_a,err) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         !> Input matrix A[m,n]
         complex(qp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
    ...
    module function stdlib_linalg_eigvalsh_noerr_w(a,upper_a) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A        
         !> Input matrix A[m,n]
         complex(qp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
  ...
  interface norm
     ...
     pure module function stdlib_linalg_norm_1D_order_char_q(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        real(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_1D_order_err_char_q(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        real(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_2D_order_char_q(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_order_err_char_q(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_order_char_q(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_order_err_char_q(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_order_char_q(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_order_err_char_q(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     !> Array norms: real(qp)
     pure module function stdlib_linalg_norm_2D_to_1D_char_q(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_to_1D_err_char_q(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_to_2D_char_q(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_to_2D_err_char_q(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_to_3D_char_q(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_to_3D_err_char_q(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     !> Scalar norms: real(qp)
     pure module function stdlib_linalg_norm_1D_order_int_q(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        real(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_1D_order_err_int_q(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        real(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_2D_order_int_q(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_order_err_int_q(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_order_int_q(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_order_err_int_q(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_order_int_q(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_order_err_int_q(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     !> Array norms: real(qp)
     pure module function stdlib_linalg_norm_2D_to_1D_int_q(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_to_1D_err_int_q(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_to_2D_int_q(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_to_2D_err_int_q(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_to_3D_int_q(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_to_3D_err_int_q(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_1D_order_char_w(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        complex(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_1D_order_err_char_w(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        complex(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_2D_order_char_w(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_order_err_char_w(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_order_char_w(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_order_err_char_w(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_order_char_w(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_order_err_char_w(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_2D_to_1D_char_w(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_to_1D_err_char_w(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_to_2D_char_w(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_to_2D_err_char_w(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_to_3D_char_w(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_to_3D_err_char_w(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
     ...
     !> Scalar norms: complex(qp)
     pure module function stdlib_linalg_norm_1D_order_int_w(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        complex(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_1D_order_err_int_w(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        complex(qp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_2D_order_int_w(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_order_err_int_w(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(qp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_order_int_w(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_order_err_int_w(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(qp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_order_int_w(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_order_err_int_w(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(qp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     !> Array norms: complex(qp)
     pure module function stdlib_linalg_norm_2D_to_1D_int_w(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_2D_to_1D_err_int_w(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_3D_to_2D_int_w(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_3D_to_2D_err_int_w(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     pure module function stdlib_linalg_norm_4D_to_3D_int_w(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
     ...
     module function stdlib_linalg_norm_4D_to_3D_err_int_w(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(qp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
  ...
  interface get_norm
     ...
     !!     
        ...
        !> Scalar norms: real(qp)
        pure module subroutine norm_1D_char_q(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           real(qp), intent(in), target :: a(:)
           !> Norm of the matrix.
        ...
        pure module subroutine norm_2D_char_q(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           real(qp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_3D_char_q(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           real(qp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_4D_char_q(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           real(qp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        !> Array norms: real(qp)
        pure module subroutine norm_2D_to_1D_char_q(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(qp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_3D_to_2D_char_q(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(qp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_4D_to_3D_char_q(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(qp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        !> Scalar norms: real(qp)
        pure module subroutine norm_1D_int_q(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           real(qp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_2D_int_q(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           real(qp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_3D_int_q(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           real(qp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_4D_int_q(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           real(qp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        !> Array norms: real(qp)
        pure module subroutine norm_2D_to_1D_int_q(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(qp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_3D_to_2D_int_q(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(qp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_4D_to_3D_int_q(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(qp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        !> Scalar norms: complex(qp)
        pure module subroutine norm_1D_char_w(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           complex(qp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_2D_char_w(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           complex(qp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_3D_char_w(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           complex(qp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_4D_char_w(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           complex(qp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        !> Array norms: complex(qp)
        pure module subroutine norm_2D_to_1D_char_w(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(qp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_3D_to_2D_char_w(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(qp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_4D_to_3D_char_w(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(qp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        !> Scalar norms: complex(qp)
        pure module subroutine norm_1D_int_w(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           complex(qp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_2D_int_w(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           complex(qp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_3D_int_w(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           complex(qp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        pure module subroutine norm_4D_int_w(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           complex(qp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(qp), intent(out) :: nrm
        ...
        !> Array norms: complex(qp)
        pure module subroutine norm_2D_to_1D_int_w(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(qp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_3D_to_2D_int_w(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(qp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
        ...
        pure module subroutine norm_4D_to_3D_int_w(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(qp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
  ...
  interface mnorm
     ...
     !!
      ...
      !> Matrix norms: real(qp) rank-2 arrays
      module function matrix_norm_char_q(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        real(qp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(qp) :: nrm
      ...
      !> Matrix norms: real(qp) higher rank arrays
      module function matrix_norm_3D_to_1D_char_q(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
      ...
      module function matrix_norm_4D_to_2D_char_q(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(qp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(qp), allocatable :: nrm(:,:)
      ...
      !> Matrix norms: real(qp) rank-2 arrays
      module function matrix_norm_int_q(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        real(qp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(qp) :: nrm
      ...
      !> Matrix norms: real(qp) higher rank arrays
      module function matrix_norm_3D_to_1D_int_q(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(qp), intent(in), contiguous, target :: a(:,:,:)
          !> Norm of the matrix.        
          real(qp), allocatable :: nrm(:)
      ...
      module function matrix_norm_4D_to_2D_int_q(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(qp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(qp), allocatable :: nrm(:,:)
      ...
      !> Matrix norms: complex(qp) rank-2 arrays
      module function matrix_norm_char_w(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        complex(qp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(qp) :: nrm
      ...
      !> Matrix norms: complex(qp) higher rank arrays
      module function matrix_norm_3D_to_1D_char_w(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
      ...
      module function matrix_norm_4D_to_2D_char_w(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(qp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(qp), allocatable :: nrm(:,:)
      ...
      !> Matrix norms: complex(qp) rank-2 arrays
      module function matrix_norm_int_w(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        complex(qp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(qp) :: nrm
      ...
      !> Matrix norms: complex(qp) higher rank arrays
      module function matrix_norm_3D_to_1D_int_w(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(qp), intent(in), contiguous, target :: a(:,:,:)
          !> Norm of the matrix.        
          real(qp), allocatable :: nrm(:)
      ...
      module function matrix_norm_4D_to_2D_int_w(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(qp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(qp), allocatable :: nrm(:,:)
...
contains
    ...
    pure function eye_rqp(dim1, dim2, mold) result(result)
    ...
    pure function eye_cqp(dim1, dim2, mold) result(result)

        integer, intent(in) :: dim1
        integer, intent(in), optional :: dim2
        complex(qp), intent(in) :: mold        
        complex(qp), allocatable :: result(:, :)
