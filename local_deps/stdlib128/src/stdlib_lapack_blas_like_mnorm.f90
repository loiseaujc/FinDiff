       ...
       ! =====================================================================
           ...
           if( min( m, n )==0_ilp ) then
              ...
              do j = 1, n
                 do i = 1, m
                    temp = abs( a( i, j ) )
                    if( value<temp .or. stdlib_qisnan( temp ) ) value = temp
                 end do
              end do
           else if( ( stdlib_lsame( norm, 'O' ) ) .or. ( norm=='1' ) ) then
              ! find norm1(a).
              ...
              do j = 1, n
                 ...
                 if( value<sum .or. stdlib_qisnan( sum ) ) value = sum
              end do
           else if( stdlib_lsame( norm, 'I' ) ) then
              ! find normi(a).
              do i = 1, m
              ...
              sum = one
              do j = 1, n
                 call stdlib_qlassq( m, a( 1_ilp, j ), 1_ilp, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_qlange = value
     ...
     !! complex matrix A.
       ...
       ! =====================================================================
           ...
           if( min( m, n )==0_ilp ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_wlassq( m, a( 1_ilp, j ), 1_ilp, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_wlange = value
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              do j = 1, n
                 l = max( 1_ilp, j-ku )
                 k = ku + 1_ilp - j + l
                 call stdlib_qlassq( min( n, j+kl )-l+1, ab( k, j ), 1_ilp, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_qlangb = value
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              do j = 1, n
                 l = max( 1_ilp, j-ku )
                 k = ku + 1_ilp - j + l
                 call stdlib_wlassq( min( n, j+kl )-l+1, ab( k, j ), 1_ilp, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_wlangb = value
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp ) then
              ...
              if( n==1_ilp ) then
                 ...
                 anorm = abs( d( 1_ilp ) )+abs( dl( 1_ilp ) )
                 temp = abs( d( n ) )+abs( du( n-1 ) )
                 if( anorm < temp .or. stdlib_qisnan( temp ) ) anorm = temp
                 do i = 2, n - 1
                    temp = abs( d( i ) )+abs( dl( i ) )+abs( du( i-1 ) )
                    if( anorm < temp .or. stdlib_qisnan( temp ) ) anorm = temp
                 end do
              ...
              scale = zero
              sum = one
              call stdlib_qlassq( n, d, 1_ilp, scale, sum )
              if( n>1_ilp ) then
                 call stdlib_qlassq( n-1, dl, 1_ilp, scale, sum )
                 call stdlib_qlassq( n-1, du, 1_ilp, scale, sum )
              end if
              anorm = scale*sqrt( sum )
           end if
           stdlib_qlangt = anorm
     ...
     !! complex tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp ) then
              ...
              scale = zero
              sum = one
              call stdlib_wlassq( n, d, 1_ilp, scale, sum )
              if( n>1_ilp ) then
                 call stdlib_wlassq( n-1, dl, 1_ilp, scale, sum )
                 call stdlib_wlassq( n-1, du, 1_ilp, scale, sum )
              end if
              anorm = scale*sqrt( sum )
           end if
           stdlib_wlangt = anorm
     ...
     !! Hessenberg matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_qlassq( min( n, j+1 ), a( 1_ilp, j ), 1_ilp, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_qlanhs = value
     ...
     !! Hessenberg matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_wlassq( min( n, j+1 ), a( 1_ilp, j ), 1_ilp, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_wlanhs = value
     ...
     !! complex Hermitian matrix A in RFP format.
        ...
        ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              stdlib_wlanhf = abs(real(a(0_ilp),KIND=qp))
              return
           end if
           ! set noe = 1 if n is odd. if n is even set noe=0
           noe = 1_ilp
              ...
              if( noe==1_ilp ) then
                 ...
                 if( ifm==1_ilp ) then
                    ...
                    if( ilu==1_ilp ) then
                       ...
                       j = k - 1_ilp
                       ! -> u(j,j) is at a(0,j)
                       temp = abs( real( a( 0_ilp+j*lda ),KIND=qp) )
                       if( value < temp .or. stdlib_qisnan( temp ) )value = temp
                       do i = 1, k - 1
                          temp = abs( a( i+j*lda ) )
                          if( value < temp .or. stdlib_qisnan( temp ) )value = temp
              ...
              if( ifm==1_ilp ) then
                 ...
                 if( noe==1_ilp ) then
                    ...
                    if( ilu==0_ilp ) then
                       ...
                       ! j=n1=k-1 is special
                       s = abs( real( a( 0_ilp+j*lda ),KIND=qp) )
                       ! a(k-1,k-1)
                       do i = 1, k - 1
                          aa = abs( a( i+j*lda ) )
                          ! a(k-1,i+n1)
                    ...
                    if( ilu==0_ilp ) then
                       ...
                       ! j=k
                       aa = abs( real( a( 0_ilp+j*lda ),KIND=qp) )
                       ! a(k,k)
                       s = aa
                       do i = 1, k - 1
                          aa = abs( a( i+j*lda ) )
              ...
              if( noe==1_ilp ) then
                 ...
                 if( ifm==1_ilp ) then
                    ...
                    if( ilu==0_ilp ) then
                       ! a is upper
                       do j = 0, k - 3
                          call stdlib_wlassq( k-j-2, a( k+j+1+j*lda ), 1_ilp, scale, s )
                          ! l at a(k,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_wlassq( k+j-1, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_wlassq( n-j-1, a( j+1+j*lda ), 1_ilp, scale, s )
                          ! trap l at a(0,0)
                       end do
                       do j = 1, k - 2
                          call stdlib_wlassq( j, a( 0_ilp+( 1_ilp+j )*lda ), 1_ilp, scale, s )
                          ! u at a(0,1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       aa = real( a( 0_ilp ),KIND=qp)
                       ! l(0,0) at a(0,0)
                       if( aa/=zero ) then
                          if( scale<aa ) then
                             s = one + s*( scale / aa )**2_ilp
                    ...
                    if( ilu==0_ilp ) then
                       ! a**h is upper
                       do j = 1, k - 2
                          call stdlib_wlassq( j, a( 0_ilp+( k+j )*lda ), 1_ilp, scale, s )
                          ! u at a(0,k)
                       end do
                       do j = 0, k - 2
                          call stdlib_wlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! k by k-1 rect. at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_wlassq( k-j-1, a( j+1+( j+k-1 )*lda ), 1_ilp,scale, s )
                          ! l at a(0,k-1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! a**h is lower
                       do j = 1, k - 1
                          call stdlib_wlassq( j, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! u at a(0,0)
                       end do
                       do j = k, n - 1
                          call stdlib_wlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       do j = 0, k - 3
                          call stdlib_wlassq( k-j-2, a( j+2+j*lda ), 1_ilp, scale, s )
                          ! l at a(1,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                 ...
                 if( ifm==1_ilp ) then
                    ...
                    if( ilu==0_ilp ) then
                       ! a is upper
                       do j = 0, k - 2
                          call stdlib_wlassq( k-j-1, a( k+j+2+j*lda ), 1_ilp, scale, s )
                       ! l at a(k+1,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_wlassq( k+j, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_wlassq( n-j-1, a( j+2+j*lda ), 1_ilp, scale, s )
                          ! trap l at a(1,0)
                       end do
                       do j = 1, k - 1
                          call stdlib_wlassq( j, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                    ...
                    if( ilu==0_ilp ) then
                       ! a**h is upper
                       do j = 1, k - 1
                          call stdlib_wlassq( j, a( 0_ilp+( k+1+j )*lda ), 1_ilp, scale, s )
                       ! u at a(0,k+1)
                       end do
                       do j = 0, k - 1
                          call stdlib_wlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_wlassq( k-j-1, a( j+1+( j+k )*lda ), 1_ilp, scale,s )
                       ! l at a(0,k)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! a**h is lower
                       do j = 1, k - 1
                          call stdlib_wlassq( j, a( 0_ilp+( j+1 )*lda ), 1_ilp, scale, s )
                       ! u at a(0,1)
                       end do
                       do j = k + 1, n
                          call stdlib_wlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_wlassq( k-j-1, a( j+1+j*lda ), 1_ilp, scale, s )
                       ! l at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
              ...
              if( noe==1_ilp ) then
                 ...
                 if( ifm==1_ilp ) then
                    ...
                    if( ilu==0_ilp ) then
                       ! a is upper
                       do j = 0, k - 3
                          call stdlib_qlassq( k-j-2, a( k+j+1+j*lda ), 1_ilp, scale, s )
                          ! l at a(k,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_qlassq( k+j-1, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k-1, a( k ), lda+1, scale, s )
                       ! tri l at a(k,0)
                       call stdlib_qlassq( k, a( k-1 ), lda+1, scale, s )
                       ! tri u at a(k-1,0)
                    else
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_qlassq( n-j-1, a( j+1+j*lda ), 1_ilp, scale, s )
                          ! trap l at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_qlassq( j, a( 0_ilp+( 1_ilp+j )*lda ), 1_ilp, scale, s )
                          ! u at a(0,1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k, a( 0_ilp ), lda+1, scale, s )
                       ! tri l at a(0,0)
                       call stdlib_qlassq( k-1, a( 0_ilp+lda ), lda+1, scale, s )
                       ! tri u at a(0,1)
                    end if
                 else
                    ! a is xpose
                    if( ilu==0_ilp ) then
                       ! a**t is upper
                       do j = 1, k - 2
                          call stdlib_qlassq( j, a( 0_ilp+( k+j )*lda ), 1_ilp, scale, s )
                          ! u at a(0,k)
                       end do
                       do j = 0, k - 2
                          call stdlib_qlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! k by k-1 rect. at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_qlassq( k-j-1, a( j+1+( j+k-1 )*lda ), 1_ilp,scale, s )
                          ! l at a(0,k-1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k-1, a( 0_ilp+k*lda ), lda+1, scale, s )
                       ! tri u at a(0,k)
                       call stdlib_qlassq( k, a( 0_ilp+( k-1 )*lda ), lda+1, scale, s )
                       ! tri l at a(0,k-1)
                    else
                       ! a**t is lower
                       do j = 1, k - 1
                          call stdlib_qlassq( j, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! u at a(0,0)
                       end do
                       do j = k, n - 1
                          call stdlib_qlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       do j = 0, k - 3
                          call stdlib_qlassq( k-j-2, a( j+2+j*lda ), 1_ilp, scale, s )
                          ! l at a(1,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k, a( 0_ilp ), lda+1, scale, s )
                       ! tri u at a(0,0)
                       call stdlib_qlassq( k-1, a( 1_ilp ), lda+1, scale, s )
                       ! tri l at a(1,0)
                    end if
                 end if
              else
                 ...
                 if( ifm==1_ilp ) then
                    ...
                    if( ilu==0_ilp ) then
                       ! a is upper
                       do j = 0, k - 2
                          call stdlib_qlassq( k-j-1, a( k+j+2+j*lda ), 1_ilp, scale, s )
                          ! l at a(k+1,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_qlassq( k+j, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k, a( k+1 ), lda+1, scale, s )
                       ! tri l at a(k+1,0)
                       call stdlib_qlassq( k, a( k ), lda+1, scale, s )
                       ! tri u at a(k,0)
                    else
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_qlassq( n-j-1, a( j+2+j*lda ), 1_ilp, scale, s )
                          ! trap l at a(1,0)
                       end do
                       do j = 1, k - 1
                          call stdlib_qlassq( j, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k, a( 1_ilp ), lda+1, scale, s )
                       ! tri l at a(1,0)
                       call stdlib_qlassq( k, a( 0_ilp ), lda+1, scale, s )
                       ! tri u at a(0,0)
                    end if
                    ...
                    if( ilu==0_ilp ) then
                       ! a**t is upper
                       do j = 1, k - 1
                          call stdlib_qlassq( j, a( 0_ilp+( k+1+j )*lda ), 1_ilp, scale, s )
                          ! u at a(0,k+1)
                       end do
                       do j = 0, k - 1
                          call stdlib_qlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_qlassq( k-j-1, a( j+1+( j+k )*lda ), 1_ilp, scale,s )
                          ! l at a(0,k)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k, a( 0_ilp+( k+1 )*lda ), lda+1, scale, s )
                       ! tri u at a(0,k+1)
                       call stdlib_qlassq( k, a( 0_ilp+k*lda ), lda+1, scale, s )
                       ! tri l at a(0,k)
                    else
                       ! a**t is lower
                       do j = 1, k - 1
                          call stdlib_qlassq( j, a( 0_ilp+( j+1 )*lda ), 1_ilp, scale, s )
                          ! u at a(0,1)
                       end do
                       do j = k + 1, n
                          call stdlib_qlassq( k, a( 0_ilp+j*lda ), 1_ilp, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_qlassq( k-j-1, a( j+1+j*lda ), 1_ilp, scale, s )
                          ! l at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_qlassq( k, a( lda ), lda+1, scale, s )
                       ! tri l at a(0,1)
                       call stdlib_qlassq( k, a( 0_ilp ), lda+1, scale, s )
                       ! tri u at a(0,0)
                    end if
     ...
     !! complex hermitian matrix A,  supplied in packed form.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_wlassq( j-1, ap( k ), 1_ilp, scale, sum )
                    k = k + j
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_wlassq( n-j, ap( k ), 1_ilp, scale, sum )
                    k = k + n - j + 1_ilp
                 end do
              end if
              sum = 2_ilp*sum
     ...
     !! real symmetric matrix A,  supplied in packed form.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_qlassq( j-1, ap( k ), 1_ilp, scale, sum )
                    k = k + j
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_qlassq( n-j, ap( k ), 1_ilp, scale, sum )
                    k = k + n - j + 1_ilp
                 end do
              end if
              sum = 2_ilp*sum
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 ...
                 do j = 1, n
                    sum = abs( real( ab( 1_ilp, j ),KIND=qp) )
                    if( value < sum .or. stdlib_qisnan( sum ) ) value = sum
                    do i = 2, min( n+1-j, k+1 )
                       sum = abs( ab( i, j ) )
                       if( value < sum .or. stdlib_qisnan( sum ) ) value = sum
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 ...
                 do j = 1, n
                    sum = work( j ) + abs( real( ab( 1_ilp, j ),KIND=qp) )
                    l = 1_ilp - j
                    do i = j + 1, min( n, j+k )
                       absa = abs( ab( l+i, j ) )
                       sum = sum + absa
              ...
              if( k>0_ilp ) then
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    do j = 2, n
                       call stdlib_wlassq( min( j-1, k ), ab( max( k+2-j, 1_ilp ), j ),1_ilp, scale, sum )
                                 
                    end do
                    l = k + 1_ilp
                 else
                    do j = 1, n - 1
                       call stdlib_wlassq( min( n-j, k ), ab( 2_ilp, j ), 1_ilp, scale,sum )
                    end do
                    l = 1_ilp
                 end if
                 sum = 2_ilp*sum
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              if( k>0_ilp ) then
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    do j = 2, n
                       call stdlib_qlassq( min( j-1, k ), ab( max( k+2-j, 1_ilp ), j ),1_ilp, scale, sum )
                                 
                    end do
                    l = k + 1_ilp
                 else
                    do j = 1, n - 1
                       call stdlib_qlassq( min( n-j, k ), ab( 2_ilp, j ), 1_ilp, scale,sum )
                    end do
                    l = 1_ilp
                 end if
                 sum = 2_ilp*sum
              ...
              call stdlib_qlassq( n, ab( l, 1_ilp ), ldab, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_qlansb = value
           return
     ...
     !! n by n symmetric band matrix A,  with k super-diagonals.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              call stdlib_wlassq( n, ab( l, 1_ilp ), ldab, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_wlansb = value
           return
     ...
     !! complex Hermitian tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp ) then
              ...
              do i = 1, n - 1
                 sum =  abs( d( i ) )
                 if( anorm < sum .or. stdlib_qisnan( sum ) ) anorm = sum
                 sum = abs( e( i ) )
                 if( anorm < sum .or. stdlib_qisnan( sum ) ) anorm = sum
              end do
           else if( stdlib_lsame( norm, 'O' ) .or. norm=='1' .or.stdlib_lsame( norm, 'I' ) ) &
              ...
              sum = one
              if( n>1_ilp ) then
                 call stdlib_wlassq( n-1, e, 1_ilp, scale, sum )
                 sum = 2_ilp*sum
              end if
              call stdlib_qlassq( n, d, 1_ilp, scale, sum )
              anorm = scale*sqrt( sum )
     ...
     !! real symmetric tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp ) then
              ...
              sum = one
              if( n>1_ilp ) then
                 call stdlib_qlassq( n-1, e, 1_ilp, scale, sum )
                 sum = 2_ilp*sum
              end if
              call stdlib_qlassq( n, d, 1_ilp, scale, sum )
              anorm = scale*sqrt( sum )
           ...
           if( min( m, n )==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 2, n
                       call stdlib_qlassq( min( m, j-1 ), a( 1_ilp, j ), 1_ilp, scale, sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_qlassq( min( m, j ), a( 1_ilp, j ), 1_ilp, scale, sum )
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 1, n
                       call stdlib_qlassq( m-j, a( min( m, j+1 ), j ), 1_ilp, scale,sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_qlassq( m-j+1, a( j, j ), 1_ilp, scale, sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           ...
           if( min( m, n )==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 2, n
                       call stdlib_wlassq( min( m, j-1 ), a( 1_ilp, j ), 1_ilp, scale, sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_wlassq( min( m, j ), a( 1_ilp, j ), 1_ilp, scale, sum )
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 1, n
                       call stdlib_wlassq( m-j, a( min( m, j+1 ), j ), 1_ilp, scale,sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_wlassq( m-j+1, a( j, j ), 1_ilp, scale, sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp
                    do j = 1, n
                       call stdlib_qlassq( j, ap( k ), 1_ilp, scale, sum )
                       k = k + j
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp
                    do j = 1, n
                       call stdlib_qlassq( n-j+1, ap( k ), 1_ilp, scale, sum )
                       k = k + n - j + 1_ilp
                    end do
                 end if
              end if
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp
                    do j = 1, n
                       call stdlib_wlassq( j, ap( k ), 1_ilp, scale, sum )
                       k = k + j
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp
                    do j = 1, n
                       call stdlib_wlassq( n-j+1, ap( k ), 1_ilp, scale, sum )
                       k = k + n - j + 1_ilp
                    end do
                 end if
              end if
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    if( k>0_ilp ) then
                       do j = 2, n
                          call stdlib_qlassq( min( j-1, k ),ab( max( k+2-j, 1_ilp ), j ), 1_ilp, scale,&
                                    sum )
                       end do
                    end if
                 else
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_qlassq( min( j, k+1 ), ab( max( k+2-j, 1_ilp ), j ),1_ilp, scale, sum )
                 ...
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_qlassq( min( n-j+1, k+1 ), ab( 1_ilp, j ), 1_ilp, scale,sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    if( k>0_ilp ) then
                       do j = 2, n
                          call stdlib_wlassq( min( j-1, k ),ab( max( k+2-j, 1_ilp ), j ), 1_ilp, scale,&
                                    sum )
                       end do
                    end if
                 else
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_wlassq( min( j, k+1 ), ab( max( k+2-j, 1_ilp ), j ),1_ilp, scale, sum )
                 ...
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_wlassq( min( n-j+1, k+1 ), ab( 1_ilp, j ), 1_ilp, scale,sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
     ...
     !! real symmetric matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_qlassq( j-1, a( 1_ilp, j ), 1_ilp, scale, sum )
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_qlassq( n-j, a( j+1, j ), 1_ilp, scale, sum )
                 end do
              end if
              sum = 2_ilp*sum
              call stdlib_qlassq( n, a, lda+1, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_qlansy = value
           return
     ...
     !! complex symmetric matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_wlassq( j-1, a( 1_ilp, j ), 1_ilp, scale, sum )
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_wlassq( n-j, a( j+1, j ), 1_ilp, scale, sum )
                 end do
              end if
              sum = 2_ilp*sum
              call stdlib_wlassq( n, a, lda+1, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_wlansy = value
           return
