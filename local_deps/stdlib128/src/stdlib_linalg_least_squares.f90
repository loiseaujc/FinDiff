...
!! Least-squares solution to Ax=b
     ...
     ! Workspace needed by gelsd
     elemental subroutine qgelsd_space(m,n,nrhs,lrwork,liwork,lcwork)
         integer(ilp), intent(in) :: m,n,nrhs
         integer(ilp), intent(out) :: lrwork,liwork,lcwork
     ...
     ! Workspace needed by gelsd
     elemental subroutine wgelsd_space(m,n,nrhs,lrwork,liwork,lcwork)
         integer(ilp), intent(in) :: m,n,nrhs
         integer(ilp), intent(out) :: lrwork,liwork,lcwork
     ...
     !!
         ...
         call stdlib_linalg_q_solve_lstsq_one(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
     ...
     !!
         ...
         call stdlib_linalg_w_solve_lstsq_one(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
     ...
     !!
         ...
         call stdlib_linalg_q_solve_lstsq_many(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
     ...
     !!
         ...
         call stdlib_linalg_w_solve_lstsq_many(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
