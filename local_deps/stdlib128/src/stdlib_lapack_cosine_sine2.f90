  ...
  contains
     ...
     ldx11, x12,ldx12, x21, ldx21, x22, ldx22, theta,u1, ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, &
        ...
        ! ===================================================================
           ...
           if( info == 0_ilp .and. min( p, m-p ) < min( q, m-q ) ) then
              ...
              call stdlib_qorcsd( jobv1t, jobv2t, jobu1, jobu2, transt, signst, m,q, p, x11, &
              ldx11, x21, ldx21, x12, ldx12, x22,ldx22, theta, v1t, ldv1t, v2t, ldv2t, u1, ldu1,&
                        u2, ldu2, work, lwork, iwork, info )
              return
           end if
           ...
           if( info == 0_ilp .and. m-q < q ) then
              ...
              call stdlib_qorcsd( jobu2, jobu1, jobv2t, jobv1t, trans, signst, m,m-p, m-q, x22, &
              ldx22, x21, ldx21, x12, ldx12, x11,ldx11, theta, u2, ldu2, u1, ldu1, v2t, ldv2t, &
                        v1t,ldv1t, work, lwork, iwork, info )
              return
           end if
           ...
           if( info == 0_ilp ) then
              ...
              itauq2 = itauq1 + max( 1_ilp, q )
              iorgqr = itauq2 + max( 1_ilp, m - q )
              call stdlib_qorgqr( m-q, m-q, m-q, u1, max(1_ilp,m-q), u1, work, -1_ilp,childinfo )
              lorgqrworkopt = int( work(1_ilp),KIND=ilp)
              lorgqrworkmin = max( 1_ilp, m - q )
              iorglq = itauq2 + max( 1_ilp, m - q )
              call stdlib_qorglq( m-q, m-q, m-q, u1, max(1_ilp,m-q), u1, work, -1_ilp,childinfo )
              lorglqworkopt = int( work(1_ilp),KIND=ilp)
              lorglqworkmin = max( 1_ilp, m - q )
              iorbdb = itauq2 + max( 1_ilp, m - q )
              call stdlib_qorbdb( trans, signs, m, p, q, x11, ldx11, x12, ldx12,x21, ldx21, x22, &
                        ldx22, theta, v1t, u1, u2, v1t,v2t, work, -1_ilp, childinfo )
              lorbdbworkopt = int( work(1_ilp),KIND=ilp)
              lorbdbworkmin = lorbdbworkopt
              ib11d = itauq2 + max( 1_ilp, m - q )
              ...
              ib22e = ib22d + max( 1_ilp, q )
              ibbcsd = ib22e + max( 1_ilp, q - 1_ilp )
              call stdlib_qbbcsd( jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q,theta, theta, u1, &
              ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, u1, u1, u1, u1, u1, u1, u1, u1, work, -1_ilp,&
                        childinfo )
              lbbcsdworkopt = int( work(1_ilp),KIND=ilp)
              lbbcsdworkmin = lbbcsdworkopt
           ...
           if( colmajor ) then
              if( wantu1 .and. p > 0_ilp ) then
                 call stdlib_qlacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
                 call stdlib_qorgqr( p, p, q, u1, ldu1, work(itaup1), work(iorgqr),lorgqrwork, &
                           info)
              end if
              if( wantu2 .and. m-p > 0_ilp ) then
                 call stdlib_qlacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
                 call stdlib_qorgqr( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorgqr), lorgqrwork,&
                            info )
              end if
              if( wantv1t .and. q > 0_ilp ) then
                 call stdlib_qlacpy( 'U', q-1, q-1, x11(1_ilp,2_ilp), ldx11, v1t(2_ilp,2_ilp),ldv1t )
                 v1t(1_ilp, 1_ilp) = one
                 do j = 2, q
                    v1t(1_ilp,j) = zero
                    v1t(j,1_ilp) = zero
                 end do
                 call stdlib_qorglq( q-1, q-1, q-1, v1t(2_ilp,2_ilp), ldv1t, work(itauq1),work(iorglq), &
                           lorglqwork, info )
              end if
              if( wantv2t .and. m-q > 0_ilp ) then
                 call stdlib_qlacpy( 'U', p, m-q, x12, ldx12, v2t, ldv2t )
                 if (m-p > q) then
                    call stdlib_qlacpy( 'U', m-p-q, m-p-q, x22(q+1,p+1), ldx22,v2t(p+1,p+1), &
                              ldv2t )
                 end if
                 if (m > q) then
                    call stdlib_qorglq( m-q, m-q, m-q, v2t, ldv2t, work(itauq2),work(iorglq), &
                              lorglqwork, info )
                 end if
              end if
           else
              if( wantu1 .and. p > 0_ilp ) then
                 call stdlib_qlacpy( 'U', q, p, x11, ldx11, u1, ldu1 )
                 call stdlib_qorglq( p, p, q, u1, ldu1, work(itaup1), work(iorglq),lorglqwork, &
                           info)
              end if
              if( wantu2 .and. m-p > 0_ilp ) then
                 call stdlib_qlacpy( 'U', q, m-p, x21, ldx21, u2, ldu2 )
                 call stdlib_qorglq( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorglq), lorglqwork,&
                            info )
              end if
              if( wantv1t .and. q > 0_ilp ) then
                 call stdlib_qlacpy( 'L', q-1, q-1, x11(2_ilp,1_ilp), ldx11, v1t(2_ilp,2_ilp),ldv1t )
                 v1t(1_ilp, 1_ilp) = one
                 do j = 2, q
                    v1t(1_ilp,j) = zero
                    v1t(j,1_ilp) = zero
                 end do
                 call stdlib_qorgqr( q-1, q-1, q-1, v1t(2_ilp,2_ilp), ldv1t, work(itauq1),work(iorgqr), &
                           lorgqrwork, info )
              end if
              if( wantv2t .and. m-q > 0_ilp ) then
           ...
           ! compute the csd of the matrix in bidiagonal-block form
           call stdlib_qbbcsd( jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, theta,work(iphi), u1,&
            ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, work(ib11d), work(ib11e), work(ib12d),work(&
            ib12e), work(ib21d), work(ib21e), work(ib22d),work(ib22e), work(ibbcsd), lbbcsdwork, &
                      info )
           ! permute rows and columns to place identity submatrices in top-
           ...
           if( q > 0_ilp .and. wantu2 ) then
              ...
              if( colmajor ) then
                 call stdlib_qlapmt( .false., m-p, m-p, u2, ldu2, iwork )
              else
                 call stdlib_qlapmr( .false., m-p, m-p, u2, ldu2, iwork )
              end if
           end if
           if( m > 0_ilp .and. wantv2t ) then
              do i = 1, p
              ...
              if( .not. colmajor ) then
                 call stdlib_qlapmt( .false., m-q, m-q, v2t, ldv2t, iwork )
              else
                 call stdlib_qlapmr( .false., m-q, m-q, v2t, ldv2t, iwork )
              end if
           end if
           return
           ! end stdlib_qorcsd
     ...
     !! K2-by-K2 identity matrix, where K1 = MAX(Q+P-M,0), K2 = MAX(Q-P,0).
        ...
        ! =====================================================================
           ...
           logical(lk) :: lquery, wantu1, wantu2, wantv1t
           ! Local Arrays 
           real(qp) :: dum1(1_ilp), dum2(1_ilp,1_ilp)
           ! Intrinsic Function 
           ! Executable Statements 
           ! test input arguments
           info = 0_ilp
           ...
           ! | tauq1 (max(1,q))                        | b12d (r)    |
           ! |-----------------------------------------| b12e (r-1)  |
           ! | stdlib_qorbdb work | stdlib_qorgqr work | stdlib_qorglq work | b21d (r)    |
           ! |             |             |             | b21e (r-1)  |
           ! |             |             |             | b22d (r)    |
           ! |             |             |             | b22e (r-1)  |
           ! |             |             |             | stdlib_qbbcsd work |
           ...
           if( info == 0_ilp ) then
              ...
              lorglqopt = 1_ilp
              if( r == q ) then
                 call stdlib_qorbdb1( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1, work,-1_ilp, childinfo )
                 lorbdb = int( work(1_ilp),KIND=ilp)
                 if( wantu1 .and. p > 0_ilp ) then
                    call stdlib_qorgqr( p, p, q, u1, ldu1, dum1, work(1_ilp), -1_ilp,childinfo )
                    lorgqrmin = max( lorgqrmin, p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp),KIND=ilp) )
                 endif
                 if( wantu2 .and. m-p > 0_ilp ) then
                    call stdlib_qorgqr( m-p, m-p, q, u2, ldu2, dum1, work(1_ilp),-1_ilp, childinfo )
                              
                    lorgqrmin = max( lorgqrmin, m-p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp),KIND=ilp) )
                 end if
                 if( wantv1t .and. q > 0_ilp ) then
                    call stdlib_qorglq( q-1, q-1, q-1, v1t, ldv1t,dum1, work(1_ilp), -1_ilp, childinfo )
                              
                    lorglqmin = max( lorglqmin, q-1 )
                    lorglqopt = max( lorglqopt, int( work(1_ilp),KIND=ilp) )
                 end if
                 call stdlib_qbbcsd( jobu1, jobu2, jobv1t, 'N', 'N', m, p, q, theta,dum1, u1, &
                 ldu1, u2, ldu2, v1t, ldv1t,dum2, 1_ilp, dum1, dum1, dum1,dum1, dum1, dum1, dum1,dum1,&
                            work(1_ilp), -1_ilp, childinfo )
                 lbbcsd = int( work(1_ilp),KIND=ilp)
              else if( r == p ) then
                 call stdlib_qorbdb2( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1,work(1_ilp), -1_ilp, childinfo )
                 lorbdb = int( work(1_ilp),KIND=ilp)
                 if( wantu1 .and. p > 0_ilp ) then
                    call stdlib_qorgqr( p-1, p-1, p-1, u1(2_ilp,2_ilp), ldu1, dum1,work(1_ilp), -1_ilp, childinfo &
                              )
                    lorgqrmin = max( lorgqrmin, p-1 )
                    lorgqropt = max( lorgqropt, int( work(1_ilp),KIND=ilp) )
                 end if
                 ...
                 if( wantv1t .and. q > 0_ilp ) then
                    call stdlib_qorglq( q, q, r, v1t, ldv1t, dum1, work(1_ilp), -1_ilp,childinfo )
                    lorglqmin = max( lorglqmin, q )
                    lorglqopt = max( lorglqopt, int( work(1_ilp),KIND=ilp) )
                 end if
                 call stdlib_qbbcsd( jobv1t, 'N', jobu1, jobu2, 'T', m, q, p, theta,dum1, v1t, &
                 ldv1t, dum2, 1_ilp, u1, ldu1,u2, ldu2, dum1, dum1, dum1,dum1, dum1, dum1, dum1,dum1, &
                           work(1_ilp), -1_ilp, childinfo )
                 lbbcsd = int( work(1_ilp),KIND=ilp)
              else if( r == m-p ) then
                 call stdlib_qorbdb3( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1,work(1_ilp), -1_ilp, childinfo )
                 lorbdb = int( work(1_ilp),KIND=ilp)
                 if( wantu1 .and. p > 0_ilp ) then
                    call stdlib_qorgqr( p, p, q, u1, ldu1, dum1, work(1_ilp), -1_ilp,childinfo )
                 ...
                 if( wantu2 .and. m-p > 0_ilp ) then
                    call stdlib_qorgqr( m-p-1, m-p-1, m-p-1, u2(2_ilp,2_ilp), ldu2,dum1, work(1_ilp), -1_ilp, &
                              childinfo )
                    lorgqrmin = max( lorgqrmin, m-p-1 )
                    lorgqropt = max( lorgqropt, int( work(1_ilp),KIND=ilp) )
                 end if
                 ...
                 call stdlib_qbbcsd( 'N', jobv1t, jobu2, jobu1, 'T', m, m-q, m-p,theta, dum1, &
                 dum2, 1_ilp, v1t, ldv1t, u2,ldu2, u1, ldu1, dum1, dum1, dum1,dum1, dum1, dum1, dum1,&
                           dum1, work(1_ilp), -1_ilp, childinfo )
                 lbbcsd = int( work(1_ilp),KIND=ilp)
              else
                 call stdlib_qorbdb4( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1,dum1, work(1_ilp), -1_ilp, childinfo )
                 lorbdb = m + int( work(1_ilp),KIND=ilp)
                 if( wantu1 .and. p > 0_ilp ) then
                    call stdlib_qorgqr( p, p, m-q, u1, ldu1, dum1, work(1_ilp), -1_ilp,childinfo )
                    lorgqrmin = max( lorgqrmin, p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp),KIND=ilp) )
                 end if
                 if( wantu2 .and. m-p > 0_ilp ) then
                    call stdlib_qorgqr( m-p, m-p, m-q, u2, ldu2, dum1, work(1_ilp),-1_ilp, childinfo )
                              
                    lorgqrmin = max( lorgqrmin, m-p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp),KIND=ilp) )
                 end if
                 if( wantv1t .and. q > 0_ilp ) then
                    call stdlib_qorglq( q, q, q, v1t, ldv1t, dum1, work(1_ilp), -1_ilp,childinfo )
                    lorglqmin = max( lorglqmin, q )
                    lorglqopt = max( lorglqopt, int( work(1_ilp),KIND=ilp) )
                 end if
                 call stdlib_qbbcsd( jobu2, jobu1, 'N', jobv1t, 'N', m, m-p, m-q,theta, dum1, u2, &
                 ldu2, u1, ldu1, dum2,1_ilp, v1t, ldv1t, dum1, dum1, dum1,dum1, dum1, dum1, dum1,dum1,&
                            work(1_ilp), -1_ilp, childinfo )
                 lbbcsd = int( work(1_ilp),KIND=ilp)
              end if
           ...
           if( r == q ) then
              ! case 1: r = q
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_qorbdb1( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp ) then
                 call stdlib_qlacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
                 call stdlib_qorgqr( p, p, q, u1, ldu1, work(itaup1), work(iorgqr),lorgqr, &
                           childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp ) then
                 call stdlib_qlacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
                 call stdlib_qorgqr( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantv1t .and. q > 0_ilp ) then
                 v1t(1_ilp,1_ilp) = one
                 ...
                 call stdlib_qlacpy( 'U', q-1, q-1, x21(1_ilp,2_ilp), ldx21, v1t(2_ilp,2_ilp),ldv1t )
                 call stdlib_qorglq( q-1, q-1, q-1, v1t(2_ilp,2_ilp), ldv1t, work(itauq1),work(iorglq), &
                           lorglq, childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_qbbcsd( jobu1, jobu2, jobv1t, 'N', 'N', m, p, q, theta,work(iphi), u1, &
              ldu1, u2, ldu2, v1t, ldv1t,dum2, 1_ilp, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place zero submatrices in
              ...
              ! case 2: r = p
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_qorbdb2( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp ) then
                 u1(1_ilp,1_ilp) = one
                 ...
                 call stdlib_qlacpy( 'L', p-1, p-1, x11(2_ilp,1_ilp), ldx11, u1(2_ilp,2_ilp), ldu1 )
                 call stdlib_qorgqr( p-1, p-1, p-1, u1(2_ilp,2_ilp), ldu1, work(itaup1),work(iorgqr), &
                           lorgqr, childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp ) then
                 call stdlib_qlacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
              ...
              if( wantv1t .and. q > 0_ilp ) then
                 call stdlib_qlacpy( 'U', p, q, x11, ldx11, v1t, ldv1t )
                 call stdlib_qorglq( q, q, r, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_qbbcsd( jobv1t, 'N', jobu1, jobu2, 'T', m, q, p, theta,work(iphi), v1t, &
              ldv1t, dum2, 1_ilp, u1, ldu1, u2,ldu2, work(ib11d), work(ib11e), work(ib12d),work(ib12e)&
              , work(ib21d), work(ib21e),work(ib22d), work(ib22e), work(ibbcsd), lbbcsd,childinfo &
                        )
              ! permute rows and columns to place identity submatrices in
              ...
              ! case 3: r = m-p
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_qorbdb3( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp ) then
                 call stdlib_qlacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
              ...
              if( wantu2 .and. m-p > 0_ilp ) then
                 ...
                 call stdlib_qlacpy( 'L', m-p-1, m-p-1, x21(2_ilp,1_ilp), ldx21, u2(2_ilp,2_ilp),ldu2 )
                 call stdlib_qorgqr( m-p-1, m-p-1, m-p-1, u2(2_ilp,2_ilp), ldu2,work(itaup2), work(iorgqr)&
                           , lorgqr, childinfo )
              end if
              if( wantv1t .and. q > 0_ilp ) then
                 call stdlib_qlacpy( 'U', m-p, q, x21, ldx21, v1t, ldv1t )
                 call stdlib_qorglq( q, q, r, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_qbbcsd( 'N', jobv1t, jobu2, jobu1, 'T', m, m-q, m-p,theta, work(iphi), &
              dum2, 1_ilp, v1t, ldv1t, u2,ldu2, u1, ldu1, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place identity submatrices in
              ...
              if( q > r ) then
                 ...
                 if( wantu1 ) then
                    call stdlib_qlapmt( .false., p, q, u1, ldu1, iwork )
                 end if
                 if( wantv1t ) then
                    call stdlib_qlapmr( .false., q, q, v1t, ldv1t, iwork )
                 end if
              end if
           else
              ! case 4: r = m-q
              ...
              ! accumulate householder reflectors
              if( wantu2 .and. m-p > 0_ilp ) then
                 call stdlib_qcopy( m-p, work(iorbdb+p), 1_ilp, u2, 1_ilp )
              end if
              if( wantu1 .and. p > 0_ilp ) then
                 call stdlib_qcopy( p, work(iorbdb), 1_ilp, u1, 1_ilp )
                 do j = 2, p
                    u1(1_ilp,j) = zero
                 end do
                 call stdlib_qlacpy( 'L', p-1, m-q-1, x11(2_ilp,1_ilp), ldx11, u1(2_ilp,2_ilp),ldu1 )
                 call stdlib_qorgqr( p, p, m-q, u1, ldu1, work(itaup1),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp ) then
                 do j = 2, m-p
                 ...
                 call stdlib_qlacpy( 'L', m-p-1, m-q-1, x21(2_ilp,1_ilp), ldx21, u2(2_ilp,2_ilp),ldu2 )
                 call stdlib_qorgqr( m-p, m-p, m-q, u2, ldu2, work(itaup2),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantv1t .and. q > 0_ilp ) then
                 call stdlib_qlacpy( 'U', m-q, q, x21, ldx21, v1t, ldv1t )
              ...
              ! simultaneously diagonalize x11 and x21.
              call stdlib_qbbcsd( jobu2, jobu1, 'N', jobv1t, 'N', m, m-p, m-q,theta, work(iphi), &
              u2, ldu2, u1, ldu1, dum2,1_ilp, v1t, ldv1t, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place identity submatrices in
              ...
              if( p > r ) then
                 ...
                 if( wantu1 ) then
                    call stdlib_qlapmt( .false., p, p, u1, ldu1, iwork )
                 end if
                 if( wantv1t ) then
                    call stdlib_qlapmr( .false., p, q, v1t, ldv1t, iwork )
                 end if
              end if
           end if
           return
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( colmajor ) then
              ...
              do i = 1, q
                 if( i == 1_ilp ) then
                    call stdlib_qscal( p-i+1, z1, x11(i,i), 1_ilp )
                 else
                    call stdlib_qscal( p-i+1, z1*cos(phi(i-1)), x11(i,i), 1_ilp )
                    call stdlib_qaxpy( p-i+1, -z1*z3*z4*sin(phi(i-1)), x12(i,i-1),1_ilp, x11(i,i), 1_ilp )
                              
                 end if
                 if( i == 1_ilp ) then
                    call stdlib_qscal( m-p-i+1, z2, x21(i,i), 1_ilp )
                 else
                    call stdlib_qscal( m-p-i+1, z2*cos(phi(i-1)), x21(i,i), 1_ilp )
                    call stdlib_qaxpy( m-p-i+1, -z2*z3*z4*sin(phi(i-1)), x22(i,i-1),1_ilp, x21(i,i), &
                              1_ilp )
                 end if
                 theta(i) = atan2( stdlib_qnrm2( m-p-i+1, x21(i,i), 1_ilp ),stdlib_qnrm2( p-i+1, x11(&
                           i,i), 1_ilp ) )
                 if( p > i ) then
                    call stdlib_qlarfgp( p-i+1, x11(i,i), x11(i+1,i), 1_ilp, taup1(i) )
                 else if( p == i ) then
                    call stdlib_qlarfgp( p-i+1, x11(i,i), x11(i,i), 1_ilp, taup1(i) )
                 end if
                 x11(i,i) = one
                 if ( m-p > i ) then
                    call stdlib_qlarfgp( m-p-i+1, x21(i,i), x21(i+1,i), 1_ilp,taup2(i) )
                 else if ( m-p == i ) then
                    call stdlib_qlarfgp( m-p-i+1, x21(i,i), x21(i,i), 1_ilp, taup2(i) )
                 end if
                 x21(i,i) = one
                 if ( q > i ) then
                    call stdlib_qlarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp, taup1(i),x11(i,i+1), ldx11, &
                              work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_qlarf( 'L', p-i+1, m-q-i+1, x11(i,i), 1_ilp, taup1(i),x12(i,i), ldx12,&
                               work )
                 end if
                 if ( q > i ) then
                    call stdlib_qlarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp, taup2(i),x21(i,i+1), ldx21,&
                               work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_qlarf( 'L', m-p-i+1, m-q-i+1, x21(i,i), 1_ilp, taup2(i),x22(i,i), &
                              ldx22, work )
                 end if
                 if( i < q ) then
                    call stdlib_qscal( q-i, -z1*z3*sin(theta(i)), x11(i,i+1),ldx11 )
                    call stdlib_qaxpy( q-i, z2*z3*cos(theta(i)), x21(i,i+1), ldx21,x11(i,i+1), &
                              ldx11 )
                 end if
                 call stdlib_qscal( m-q-i+1, -z1*z4*sin(theta(i)), x12(i,i), ldx12 )
                 call stdlib_qaxpy( m-q-i+1, z2*z4*cos(theta(i)), x22(i,i), ldx22,x12(i,i), ldx12 &
                           )
                 if( i < q )phi(i) = atan2( stdlib_qnrm2( q-i, x11(i,i+1), ldx11 ),stdlib_qnrm2( &
                           m-q-i+1, x12(i,i), ldx12 ) )
                 if( i < q ) then
                    if ( q-i == 1_ilp ) then
                       call stdlib_qlarfgp( q-i, x11(i,i+1), x11(i,i+1), ldx11,tauq1(i) )
                    else
                       call stdlib_qlarfgp( q-i, x11(i,i+1), x11(i,i+2), ldx11,tauq1(i) )
                    end if
                    x11(i,i+1) = one
                 end if
                 if ( q+i-1 < m ) then
                 ...
                 x12(i,i) = one
                 if( i < q ) then
                    call stdlib_qlarf( 'R', p-i, q-i, x11(i,i+1), ldx11, tauq1(i),x11(i+1,i+1), &
                              ldx11, work )
                    call stdlib_qlarf( 'R', m-p-i, q-i, x11(i,i+1), ldx11, tauq1(i),x21(i+1,i+1), &
                              ldx21, work )
                 end if
                 if ( p > i ) then
                    call stdlib_qlarf( 'R', p-i, m-q-i+1, x12(i,i), ldx12, tauq2(i),x12(i+1,i), &
                              ldx12, work )
                 end if
                 if ( m-p > i ) then
                    call stdlib_qlarf( 'R', m-p-i, m-q-i+1, x12(i,i), ldx12,tauq2(i), x22(i+1,i), &
                              ldx22, work )
                 end if
              end do
              ! reduce columns q + 1, ..., p of x12, x22
              do i = q + 1, p
                 call stdlib_qscal( m-q-i+1, -z1*z4, x12(i,i), ldx12 )
                 if ( i >= m-q ) then
                    call stdlib_qlarfgp( m-q-i+1, x12(i,i), x12(i,i), ldx12,tauq2(i) )
                 else
                    call stdlib_qlarfgp( m-q-i+1, x12(i,i), x12(i,i+1), ldx12,tauq2(i) )
                 ...
                 if( m-p-q >= 1_ilp )call stdlib_qlarf( 'R', m-p-q, m-q-i+1, x12(i,i), ldx12,tauq2(i),&
                            x22(q+1,i), ldx22, work )
              end do
              ! reduce columns p + 1, ..., m - q of x12, x22
              do i = 1, m - p - q
                 ...
                 x22(q+i,p+i) = one
                 if ( i < m-p-q ) then
                    call stdlib_qlarf( 'R', m-p-q-i, m-p-q-i+1, x22(q+i,p+i), ldx22,tauq2(p+i), &
                              x22(q+i+1,p+i), ldx22, work )
                 end if
              end do
           else
              ...
              do i = 1, q
                 if( i == 1_ilp ) then
                    call stdlib_qscal( p-i+1, z1, x11(i,i), ldx11 )
                 else
                    call stdlib_qscal( p-i+1, z1*cos(phi(i-1)), x11(i,i), ldx11 )
                    call stdlib_qaxpy( p-i+1, -z1*z3*z4*sin(phi(i-1)), x12(i-1,i),ldx12, x11(i,i),&
                               ldx11 )
                 end if
                 if( i == 1_ilp ) then
                    call stdlib_qscal( m-p-i+1, z2, x21(i,i), ldx21 )
                 else
                    call stdlib_qscal( m-p-i+1, z2*cos(phi(i-1)), x21(i,i), ldx21 )
                    call stdlib_qaxpy( m-p-i+1, -z2*z3*z4*sin(phi(i-1)), x22(i-1,i),ldx22, x21(i,&
                              i), ldx21 )
                 end if
                 theta(i) = atan2( stdlib_qnrm2( m-p-i+1, x21(i,i), ldx21 ),stdlib_qnrm2( p-i+1, &
                           x11(i,i), ldx11 ) )
                 call stdlib_qlarfgp( p-i+1, x11(i,i), x11(i,i+1), ldx11, taup1(i) )
                 x11(i,i) = one
                 if ( i == m-p ) then
                    call stdlib_qlarfgp( m-p-i+1, x21(i,i), x21(i,i), ldx21,taup2(i) )
                 else
                    call stdlib_qlarfgp( m-p-i+1, x21(i,i), x21(i,i+1), ldx21,taup2(i) )
                 end if
                 x21(i,i) = one
                 if ( q > i ) then
                    call stdlib_qlarf( 'R', q-i, p-i+1, x11(i,i), ldx11, taup1(i),x11(i+1,i), &
                              ldx11, work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_qlarf( 'R', m-q-i+1, p-i+1, x11(i,i), ldx11,taup1(i), x12(i,i), &
                              ldx12, work )
                 end if
                 if ( q > i ) then
                    call stdlib_qlarf( 'R', q-i, m-p-i+1, x21(i,i), ldx21, taup2(i),x21(i+1,i), &
                              ldx21, work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_qlarf( 'R', m-q-i+1, m-p-i+1, x21(i,i), ldx21,taup2(i), x22(i,i), &
                              ldx22, work )
                 end if
                 if( i < q ) then
                    call stdlib_qscal( q-i, -z1*z3*sin(theta(i)), x11(i+1,i), 1_ilp )
                    call stdlib_qaxpy( q-i, z2*z3*cos(theta(i)), x21(i+1,i), 1_ilp,x11(i+1,i), 1_ilp )
                              
                 end if
                 call stdlib_qscal( m-q-i+1, -z1*z4*sin(theta(i)), x12(i,i), 1_ilp )
                 call stdlib_qaxpy( m-q-i+1, z2*z4*cos(theta(i)), x22(i,i), 1_ilp,x12(i,i), 1_ilp )
                           
                 if( i < q )phi(i) = atan2( stdlib_qnrm2( q-i, x11(i+1,i), 1_ilp ),stdlib_qnrm2( m-q-&
                           i+1, x12(i,i), 1_ilp ) )
                 if( i < q ) then
                    if ( q-i == 1_ilp) then
                       call stdlib_qlarfgp( q-i, x11(i+1,i), x11(i+1,i), 1_ilp,tauq1(i) )
                    else
                       call stdlib_qlarfgp( q-i, x11(i+1,i), x11(i+2,i), 1_ilp,tauq1(i) )
                    end if
                    x11(i+1,i) = one
                 end if
                 if ( m-q > i ) then
                    call stdlib_qlarfgp( m-q-i+1, x12(i,i), x12(i+1,i), 1_ilp,tauq2(i) )
                 else
                    call stdlib_qlarfgp( m-q-i+1, x12(i,i), x12(i,i), 1_ilp,tauq2(i) )
                 end if
                 x12(i,i) = one
                 if( i < q ) then
                    call stdlib_qlarf( 'L', q-i, p-i, x11(i+1,i), 1_ilp, tauq1(i),x11(i+1,i+1), ldx11,&
                               work )
                    call stdlib_qlarf( 'L', q-i, m-p-i, x11(i+1,i), 1_ilp, tauq1(i),x21(i+1,i+1), &
                              ldx21, work )
                 end if
                 call stdlib_qlarf( 'L', m-q-i+1, p-i, x12(i,i), 1_ilp, tauq2(i),x12(i,i+1), ldx12, &
                           work )
                 if ( m-p-i > 0_ilp ) then
                    call stdlib_qlarf( 'L', m-q-i+1, m-p-i, x12(i,i), 1_ilp, tauq2(i),x22(i,i+1), &
                              ldx22, work )
                 end if
              end do
              ! reduce columns q + 1, ..., p of x12, x22
              do i = q + 1, p
                 call stdlib_qscal( m-q-i+1, -z1*z4, x12(i,i), 1_ilp )
                 call stdlib_qlarfgp( m-q-i+1, x12(i,i), x12(i+1,i), 1_ilp, tauq2(i) )
                 x12(i,i) = one
                 if ( p > i ) then
                    call stdlib_qlarf( 'L', m-q-i+1, p-i, x12(i,i), 1_ilp, tauq2(i),x12(i,i+1), ldx12,&
                 ...
                 if( m-p-q >= 1_ilp )call stdlib_qlarf( 'L', m-q-i+1, m-p-q, x12(i,i), 1_ilp, tauq2(i),&
                           x22(i,q+1), ldx22, work )
              end do
              ! reduce columns p + 1, ..., m - q of x12, x22
              do i = 1, m - p - q
                 call stdlib_qscal( m-p-q-i+1, z2*z4, x22(p+i,q+i), 1_ilp )
                 if ( m-p-q == i ) then
                    call stdlib_qlarfgp( m-p-q-i+1, x22(p+i,q+i), x22(p+i,q+i), 1_ilp,tauq2(p+i) )
                              
                 else
                    call stdlib_qlarfgp( m-p-q-i+1, x22(p+i,q+i), x22(p+i+1,q+i), 1_ilp,tauq2(p+i) )
                              
                    call stdlib_qlarf( 'L', m-p-q-i+1, m-p-q-i, x22(p+i,q+i), 1_ilp,tauq2(p+i), x22(p+&
                              i,q+i+1), ldx22, work )
                 end if
                 x22(p+i,q+i) = one
              end do
     ...
     !! angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           do i = 1, q
              ...
              x11(i,i) = one
              x21(i,i) = one
              call stdlib_qlarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp, taup1(i), x11(i,i+1),ldx11, work(&
                        ilarf) )
              call stdlib_qlarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp, taup2(i),x21(i,i+1), ldx21, work(&
                        ilarf) )
              if( i < q ) then
                 call stdlib_qrot( q-i, x11(i,i+1), ldx11, x21(i,i+1), ldx21, c, s )
                 call stdlib_qlarfgp( q-i, x21(i,i+1), x21(i,i+2), ldx21, tauq1(i) )
                 s = x21(i,i+1)
                 x21(i,i+1) = one
                 call stdlib_qlarf( 'R', p-i, q-i, x21(i,i+1), ldx21, tauq1(i),x11(i+1,i+1), &
                           ldx11, work(ilarf) )
                 call stdlib_qlarf( 'R', m-p-i, q-i, x21(i,i+1), ldx21, tauq1(i),x21(i+1,i+1), &
                           ldx21, work(ilarf) )
                 c = sqrt( stdlib_qnrm2( p-i, x11(i+1,i+1), 1_ilp )**2_ilp+ stdlib_qnrm2( m-p-i, x21(i+1,&
                           i+1), 1_ilp )**2_ilp )
                 phi(i) = atan2( s, c )
                 call stdlib_qorbdb5( p-i, m-p-i, q-i-1, x11(i+1,i+1), 1_ilp,x21(i+1,i+1), 1_ilp, x11(i+1,&
                           i+2), ldx11,x21(i+1,i+2), ldx21, work(iorbdb5), lorbdb5,childinfo )
              end if
           end do
           return
     ...
     !! angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           do i = 1, p
              if( i > 1_ilp ) then
                 call stdlib_qrot( q-i+1, x11(i,i), ldx11, x21(i-1,i), ldx21, c, s )
              end if
              call stdlib_qlarfgp( q-i+1, x11(i,i), x11(i,i+1), ldx11, tauq1(i) )
              c = x11(i,i)
              x11(i,i) = one
              call stdlib_qlarf( 'R', p-i, q-i+1, x11(i,i), ldx11, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_qlarf( 'R', m-p-i+1, q-i+1, x11(i,i), ldx11, tauq1(i),x21(i,i), ldx21, &
                        work(ilarf) )
              s = sqrt( stdlib_qnrm2( p-i, x11(i+1,i), 1_ilp )**2_ilp+ stdlib_qnrm2( m-p-i+1, x21(i,i), 1_ilp &
                        )**2_ilp )
              theta(i) = atan2( s, c )
              call stdlib_qorbdb5( p-i, m-p-i+1, q-i, x11(i+1,i), 1_ilp, x21(i,i), 1_ilp,x11(i+1,i+1), &
                        ldx11, x21(i,i+1), ldx21,work(iorbdb5), lorbdb5, childinfo )
              call stdlib_qscal( p-i, negone, x11(i+1,i), 1_ilp )
              call stdlib_qlarfgp( m-p-i+1, x21(i,i), x21(i+1,i), 1_ilp, taup2(i) )
              if( i < p ) then
                 call stdlib_qlarfgp( p-i, x11(i+1,i), x11(i+2,i), 1_ilp, taup1(i) )
                 phi(i) = atan2( x11(i+1,i), x21(i,i) )
                 c = cos( phi(i) )
                 s = sin( phi(i) )
                 x11(i+1,i) = one
                 call stdlib_qlarf( 'L', p-i, q-i, x11(i+1,i), 1_ilp, taup1(i),x11(i+1,i+1), ldx11, &
                           work(ilarf) )
              end if
              x21(i,i) = one
              call stdlib_qlarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp, taup2(i),x21(i,i+1), ldx21, work(&
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           do i = 1, m-p
              if( i > 1_ilp ) then
                 call stdlib_qrot( q-i+1, x11(i-1,i), ldx11, x21(i,i), ldx11, c, s )
              end if
              call stdlib_qlarfgp( q-i+1, x21(i,i), x21(i,i+1), ldx21, tauq1(i) )
              s = x21(i,i)
              x21(i,i) = one
              call stdlib_qlarf( 'R', p-i+1, q-i+1, x21(i,i), ldx21, tauq1(i),x11(i,i), ldx11, &
                        work(ilarf) )
              call stdlib_qlarf( 'R', m-p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x21(i+1,i), ldx21, &
                        work(ilarf) )
              c = sqrt( stdlib_qnrm2( p-i+1, x11(i,i), 1_ilp )**2_ilp+ stdlib_qnrm2( m-p-i, x21(i+1,i), 1_ilp &
                        )**2_ilp )
              theta(i) = atan2( s, c )
              call stdlib_qorbdb5( p-i+1, m-p-i, q-i, x11(i,i), 1_ilp, x21(i+1,i), 1_ilp,x11(i,i+1), &
                        ldx11, x21(i+1,i+1), ldx21,work(iorbdb5), lorbdb5, childinfo )
              call stdlib_qlarfgp( p-i+1, x11(i,i), x11(i+1,i), 1_ilp, taup1(i) )
              if( i < m-p ) then
                 call stdlib_qlarfgp( m-p-i, x21(i+1,i), x21(i+2,i), 1_ilp, taup2(i) )
                 phi(i) = atan2( x21(i+1,i), x11(i,i) )
                 c = cos( phi(i) )
                 s = sin( phi(i) )
                 x21(i+1,i) = one
                 call stdlib_qlarf( 'L', m-p-i, q-i, x21(i+1,i), 1_ilp, taup2(i),x21(i+1,i+1), ldx21, &
                           work(ilarf) )
              end if
              x11(i,i) = one
              call stdlib_qlarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp, taup1(i), x11(i,i+1),ldx11, work(&
        ...
        ! ====================================================================
           ...
           do i = 1, m-q
              if( i == 1_ilp ) then
                 ...
                 call stdlib_qorbdb5( p, m-p, q, phantom(1_ilp), 1_ilp, phantom(p+1), 1_ilp,x11, ldx11, x21, &
                           ldx21, work(iorbdb5),lorbdb5, childinfo )
                 call stdlib_qscal( p, negone, phantom(1_ilp), 1_ilp )
                 call stdlib_qlarfgp( p, phantom(1_ilp), phantom(2_ilp), 1_ilp, taup1(1_ilp) )
                 call stdlib_qlarfgp( m-p, phantom(p+1), phantom(p+2), 1_ilp, taup2(1_ilp) )
                 theta(i) = atan2( phantom(1_ilp), phantom(p+1) )
                 c = cos( theta(i) )
                 s = sin( theta(i) )
                 phantom(1_ilp) = one
                 phantom(p+1) = one
                 call stdlib_qlarf( 'L', p, q, phantom(1_ilp), 1_ilp, taup1(1_ilp), x11, ldx11,work(ilarf) )
                           
                 call stdlib_qlarf( 'L', m-p, q, phantom(p+1), 1_ilp, taup2(1_ilp), x21,ldx21, work(ilarf)&
                            )
              else
                 call stdlib_qorbdb5( p-i+1, m-p-i+1, q-i+1, x11(i,i-1), 1_ilp,x21(i,i-1), 1_ilp, x11(i,i)&
                           , ldx11, x21(i,i),ldx21, work(iorbdb5), lorbdb5, childinfo )
                 call stdlib_qscal( p-i+1, negone, x11(i,i-1), 1_ilp )
                 call stdlib_qlarfgp( p-i+1, x11(i,i-1), x11(i+1,i-1), 1_ilp, taup1(i) )
                 call stdlib_qlarfgp( m-p-i+1, x21(i,i-1), x21(i+1,i-1), 1_ilp,taup2(i) )
                 theta(i) = atan2( x11(i,i-1), x21(i,i-1) )
                 c = cos( theta(i) )
                 s = sin( theta(i) )
                 x11(i,i-1) = one
                 x21(i,i-1) = one
                 call stdlib_qlarf( 'L', p-i+1, q-i+1, x11(i,i-1), 1_ilp, taup1(i),x11(i,i), ldx11, &
                           work(ilarf) )
                 call stdlib_qlarf( 'L', m-p-i+1, q-i+1, x21(i,i-1), 1_ilp, taup2(i),x21(i,i), ldx21, &
                           work(ilarf) )
              end if
              call stdlib_qrot( q-i+1, x11(i,i), ldx11, x21(i,i), ldx21, s, -c )
              call stdlib_qlarfgp( q-i+1, x21(i,i), x21(i,i+1), ldx21, tauq1(i) )
              c = x21(i,i)
              x21(i,i) = one
              call stdlib_qlarf( 'R', p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_qlarf( 'R', m-p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x21(i+1,i), ldx21, &
                        work(ilarf) )
              if( i < m-q ) then
                 s = sqrt( stdlib_qnrm2( p-i, x11(i+1,i), 1_ilp )**2_ilp+ stdlib_qnrm2( m-p-i, x21(i+1,i),&
                            1_ilp )**2_ilp )
                 phi(i) = atan2( s, c )
              end if
           end do
           ...
           do i = m - q + 1, p
              ...
              call stdlib_qlarf( 'R', p-i, q-i+1, x11(i,i), ldx11, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_qlarf( 'R', q-p, q-i+1, x11(i,i), ldx11, tauq1(i),x21(m-q+1,i), ldx21, &
                        work(ilarf) )
           end do
           ! reduce the bottom-right portion of x21 to [ 0 i ]
           do i = p + 1, q
     ...
     !! way.
        ...
        ! =====================================================================
           ...
           ! project x onto the orthogonal complement of q
           call stdlib_qorbdb6( m1, m2, n, x1, incx1, x2, incx2, q1, ldq1, q2, ldq2,work, lwork, &
                     childinfo )
           ! if the projection is nonzero, then return
           if( stdlib_qnrm2(m1,x1,incx1) /= zero.or. stdlib_qnrm2(m2,x2,incx2) /= zero ) &
                     then
              return
           end if
           ! project each standard basis vector e_1,...,e_m1 in turn, stopping
           ...
           do i = 1, m1
              ...
              call stdlib_qorbdb6( m1, m2, n, x1, incx1, x2, incx2, q1, ldq1, q2,ldq2, work, &
                        lwork, childinfo )
              if( stdlib_qnrm2(m1,x1,incx1) /= zero.or. stdlib_qnrm2(m2,x2,incx2) /= zero ) &
                        then
                 return
     ...
     !! criterion, then the zero vector is returned.
        ...
        ! =====================================================================
           ...
           scl1 = zero
           ssq1 = one
           call stdlib_qlassq( m1, x1, incx1, scl1, ssq1 )
           scl2 = zero
           ssq2 = one
           call stdlib_qlassq( m2, x2, incx2, scl2, ssq2 )
           normsq1 = scl1**2_ilp*ssq1 + scl2**2_ilp*ssq2
           if( m1 == 0_ilp ) then
              do i = 1, n
                 work(i) = zero
              ...
              call stdlib_qgemv( 'C', m1, n, one, q1, ldq1, x1, incx1, zero, work,1_ilp )
           end if
           call stdlib_qgemv( 'C', m2, n, one, q2, ldq2, x2, incx2, one, work, 1_ilp )
           call stdlib_qgemv( 'N', m1, n, negone, q1, ldq1, work, 1_ilp, one, x1,incx1 )
           call stdlib_qgemv( 'N', m2, n, negone, q2, ldq2, work, 1_ilp, one, x2,incx2 )
           scl1 = zero
           ssq1 = one
           call stdlib_qlassq( m1, x1, incx1, scl1, ssq1 )
           scl2 = zero
