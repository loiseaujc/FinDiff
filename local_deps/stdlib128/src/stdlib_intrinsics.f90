...
module stdlib_intrinsics
    ...
    interface stdlib_sum
        ...
        pure module function stdlib_sum_4d_dim_qp( x , dim, mask ) result( s )
            ...
            integer, intent(in):: dim
            logical, intent(in), optional :: mask(:,:,:,:)
            real(qp) :: s(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
                & size(x, 4), mask=3<dim))
        end function
        ...
        pure module function stdlib_sum_4d_dim_cqp( x , dim, mask ) result( s )
            ...
            integer, intent(in):: dim
            logical, intent(in), optional :: mask(:,:,:,:)
            complex(qp) :: s(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x,&
                & 3), size(x, 4), mask=3<dim))
        end function
    end interface
    public :: stdlib_sum
    ...
    interface stdlib_dot_product
        ...
        pure module function stdlib_dot_product_qp(a,b) result(p)
            real(qp), intent(in) :: a(:)
            real(qp), intent(in) :: b(:)
            real(qp) :: p
        end function
        ...
        pure module function stdlib_dot_product_cqp(a,b) result(p)
            complex(qp), intent(in) :: a(:)
    ...
    interface stdlib_dot_product_kahan
        ...
        pure module function stdlib_dot_product_kahan_qp(a,b) result(p)
            real(qp), intent(in) :: a(:)
            real(qp), intent(in) :: b(:)
            real(qp) :: p
        end function
        ...
        pure module function stdlib_dot_product_kahan_cqp(a,b) result(p)
            complex(qp), intent(in) :: a(:)
            complex(qp), intent(in) :: b(:)
            complex(qp) :: p
        end function
    ...
    interface kahan_kernel 
        ...
        module procedure :: kahan_kernel_qp
        module procedure :: kahan_kernel_m_qp
        ...
        module procedure :: kahan_kernel_cqp
        module procedure :: kahan_kernel_m_cqp
    end interface
    public :: kahan_kernel
...
elemental subroutine kahan_kernel_qp(a,s,c)
    real(qp), intent(in) :: a
...
elemental subroutine kahan_kernel_m_qp(a,s,c,m)
    real(qp), intent(in) :: a
    real(qp), intent(inout) :: s
    real(qp), intent(inout) :: c
    logical, intent(in) :: m
...
elemental subroutine kahan_kernel_cqp(a,s,c)
    complex(qp), intent(in) :: a
    complex(qp), intent(inout) :: s
...
elemental subroutine kahan_kernel_m_cqp(a,s,c,m)
    complex(qp), intent(in) :: a
    complex(qp), intent(inout) :: s
    complex(qp), intent(inout) :: c
    logical, intent(in) :: m
