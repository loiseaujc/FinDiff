...
!! Compute eigenvalues and eigenvectors    
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_q(amat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_q(amat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         real(qp), pointer :: amat(:,:),umat(:,:),vmat(:,:)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_q(amat,bmat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_q(amat,bmat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         real(qp), target :: work_dummy(1),u_dummy(1,1),v_dummy(1,1)
         real(qp), allocatable :: work(:)
         real(qp), pointer :: amat(:,:),umat(:,:),vmat(:,:),bmat(:,:)
         real(qp), pointer :: lreal(:),limag(:)
     ...
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eigh_q(amat,lambda,upper_a=upper_a,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_w(amat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_w(amat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         complex(qp), pointer :: amat(:,:),umat(:,:),vmat(:,:)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_w(amat,bmat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_w(amat,bmat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         complex(qp), target :: work_dummy(1),u_dummy(1,1),v_dummy(1,1)
         complex(qp), allocatable :: work(:)
         complex(qp), pointer :: amat(:,:),umat(:,:),vmat(:,:),bmat(:,:)
         real(qp), allocatable :: rwork(:)
     ...
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eigh_w(amat,lambda,upper_a=upper_a,err=err)
     ...
     module subroutine stdlib_linalg_real_eig_standard_q(a,lambda,right,left, &
      ...
      !! non-trivial imaginary parts.
          ...
          call stdlib_linalg_eig_standard_q(a,clambda,right,left, &
                                                 overwrite_a,err0)          
     ...
     module subroutine stdlib_linalg_real_eig_generalized_q(a,b,lambda,right,left, &
      ...
      !! non-trivial imaginary parts.
          ...
          call stdlib_linalg_eig_generalized_q(a,b,clambda,right,left, &
                                                 overwrite_a,overwrite_b,err0)          
