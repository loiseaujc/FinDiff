module stdlib_codata_type
    ...
    contains 
        ...
        procedure :: to_real_qp
        generic :: to_real => to_real_sp, to_real_dp, to_real_qp
    end type
...
elemental pure real(qp) function to_real_qp(self, mold, uncertainty) result(r)
    !! version: experimental
    !!
    !! Get the constant value or uncertainty for the kind qp
    !! ([Specification](../page/specs/stdlib_constants.html))
