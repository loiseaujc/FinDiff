...
module stdlib_constants
    ...
    real(qp), parameter, public :: PI_qp = acos(-1.0_qp) !! PI
    ...
    real(qp), parameter, public :: zero_qp = 0._qp
    real(qp), parameter, public :: one_qp  = 1._qp
    ...
    complex(qp), parameter, public :: zero_cqp = (0._qp,0._qp)
    complex(qp), parameter, public :: one_cqp  = (1._qp,0._qp)
